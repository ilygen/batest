 ...
 */
@Table("BAGIVETMPDTL")
public class Bagivetmpdtl implements Serializable {
    @PkeyField("MFILENAME")
    ...
    private String mfileReMk; // 媒體回傳處理註記
    ...
    private String dataCount; // 筆數
    private String rowNum; //序
    ...
    public String getMfileReMk() {
        return mfileReMk;
    }

    public void setMfileReMk(String mfileReMk) {
        this.mfileReMk = mfileReMk;
    }
