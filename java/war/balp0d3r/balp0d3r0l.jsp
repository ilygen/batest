...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3R0L" />
    ...
    <html:javascript formName="MonthlyBatchRptForm" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyBatchRptForm.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyBatchRpt" method="post" onsubmit="return validateMonthlyBatchRptForm(this);">
        
        <fieldset>
            <legend>&nbsp;線上月處理異動清單 &nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyBatchRptForm.onsubmit()){document.MonthlyBatchRptForm.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
