...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D330L" />
    ...
    <html:javascript formName="MonthlyRpt03Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt03" method="post" onsubmit="return validateMonthlyRpt03Form(this);">

        <fieldset>
            <legend>&nbsp;月核定差異統計表&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="3" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt03Form.onsubmit()){document.MonthlyRpt03Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
