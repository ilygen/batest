...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D061Q" />
                ...
                <tr align="center">                   
                    <td>
                        ...
                        <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">                            
                            ...
                            <display:column title="事故者身分證號" style="width:12%; text-align:center;">
                                <c:out value="${listItem.evtIdnNo}" />&nbsp;
                            </display:column>
                            <display:column title="事故者出生日期" style="width:12%; text-align:center;">
                                <c:out value="${listItem.evtBrDateStr}" />&nbsp;
                            </display:column>
                            <display:column title="給付別" style="width:12%; text-align:center;">
