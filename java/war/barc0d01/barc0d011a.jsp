...
<html:html lang="true">
<head>
    <acl:setProgId progId="BARC0D011A" />
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doSaveData'; if (checkFields()){document.PaymentDecisionForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnBack">
                            <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack'; document.PaymentDecisionForm.submit();" />&nbsp;
                        </acl:checkButton>                                             
                    </td>
                </tr>    
                <tr>
                    <td colspan="11" class="issuetitle_L">
                        <bean:define id="payTitle" name="<%=ConstantKey.PAYMENT_DECISION_CASE_FOR_TITLE%>" />                        
                ...
                <tr align="center">
                    <td>
                        <bean:define id="list" name="<%=ConstantKey.PAYMENT_DECISION_LIST%>" />
                        <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.DECISION_LIST_PAGE_SIZE%>">
                            ...
                            <display:column title="資料明細" style="width:6%; text-align:center;">
                                <acl:checkButton buttonName="btnDetail">
                                    <input type="button" name="btnDetail" class="button" value="明細資料" onclick="$('page').value='1'; $('method').value='doSingleReview'; $('apNo').value='<c:out value="${listItem.apNo}" />'; document.PaymentDecisionForm.submit();" />&nbsp;
                                </acl:checkButton>                            
                            </display:column>
                        </display:table>
                    </td>
