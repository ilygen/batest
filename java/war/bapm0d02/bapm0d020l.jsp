...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPM0D020L" />
    ...
    <script type='text/javascript' src='<c:url value="/js/ba_onload.js"/>'></script>
     <html:javascript formName="PaymentReprintForm" page="1" />
	            ...
	            <tr>
                    <td colspan="3" align="right">
                        ...
                        <html:hidden styleId="method" property="method" value="" />
 						<html:hidden styleId="printDt" property="printDt" value="" />
			            
			            <acl:checkButton buttonName="btnPrint">
			                <input name="btnPrint" type="button" class="button" value="列  印 "  onclick="$('page').value='1'; $('printDt').value=''; $('method').value='doPrint'; if (checkFieldNext() && document.PaymentReprintForm.onsubmit()){document.PaymentReprintForm.submit();}else{return false;}" />&nbsp;&nbsp;   
			            </acl:checkButton>
			            <acl:checkButton buttonName="btnReprint">
			                <input name="btnReprint" type="button" class="button" value="補  印 " onclick="$('page').value='1';$('printDt').value='show'; $('method').value='doPrint';  if (checkFieldNext() && document.PaymentReprintForm.onsubmit()){document.PaymentReprintForm.submit();}else{return false;}" />&nbsp;&nbsp;   
			            </acl:checkButton>
