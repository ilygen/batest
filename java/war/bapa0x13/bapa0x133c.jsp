...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X133C" />
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            <legend>&nbsp;失能年金所得替代率參數維護作業修改&nbsp;</legend>
            
            <div align="right" id="showtime">
                                網頁下載時間：民國&nbsp;<func:nowDateTime />
            </div>
            <bean:define id="replacementRatioData" name="<%=ConstantKey.DISABLED_REPLACEMENT_RATIO_MAINT_QUERY_CASE %>" />
	            ...
	            <tr>
                    <td colspan="6" align="right">
                        ...
                        <c:if test='${replacementRatioData.deleteUpdateStr ne "Y"}'>
                            <input name="btnSave" type="button" class="button" value="確  認 " onclick="$('page').value='1'; $('method').value='doConfirm'; if (document.DisabledReplacementRatioMaintDetailForm.onsubmit() && checkRequireFields()){document.DisabledReplacementRatioMaintDetailForm.submit();}else{return false;}" />
                        </c:if>
                        </acl:checkButton>
                        ...
                        <table width="98%" border="0" cellpadding="3" cellspacing="5" class="px13">
                            <tr>
                                <td width="20%">
                                    ...
                                    <c:out value="${DisabledReplacementRatioMaintDetailForm.user}" />
                                </td>
                                <td width="40%">
                                    <span class="issuetitle_L_down">修改日期：</span>
                                    <c:out value="${DisabledReplacementRatioMaintDetailForm.date}" />
                                </td>
                            </tr>
                        </table>
                    </td>
