...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M010X" />
    ...
    <html:javascript formName="UpdatePaidMarkBJForm" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.UpdatePaidMarkBJForm.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/updatePaidMarkBJ" method="post" onsubmit="return validateUpdatePaidMarkBJForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnQuery">
                            <input name="btnQuery" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if (document.UpdatePaidMarkBJForm.onsubmit()){document.UpdatePaidMarkBJForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
