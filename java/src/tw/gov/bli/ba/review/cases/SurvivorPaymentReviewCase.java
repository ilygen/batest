...
public class SurvivorPaymentReviewCase implements Serializable {
    ...
    private String evtJobDate; // 事故者死亡日期
    ...
    private BigDecimal nitrmM; // 勞保投保(月-年金制)
    private BigDecimal itrmY; // 勞保投保(年)
    private BigDecimal itrmD; // 勞保投保(日)
    private BigDecimal aplPaySeniY; // 實發年資(日) )
    private BigDecimal aplPaySeniM; // 實發年資(日)
    ...
    private BigDecimal oldbAmt; // 勞保給付金額
    ...
    private List<SurvivorPaymentReviewExtCase> benIssueDataList;// 受款人核定資料
    private List<SurvivorPaymentReviewExtCase> benChkDataList;// 受款人的編審註記
    private List<SurvivorPaymentReviewExtCase> otherChkDataList;// 眷屬編審註記/符合註記
    private SurvivorPaymentReviewExtCase[] benIssueDataArray;// 受款人核定資料Array
    ...
    private String manchkMkCtlY;// 人工審核 合格 radio button 是否disabled (Y:enable, N:disabled)
    private String manchkMkCtlN;// 人工審核 不合格 radio button 是否disabled (Y:enable, N:disabled)
    private String manchkMkCtlSpace;// 人工審核 待處理 radio button 是否disabled (Y:enable, N:disabled)
    ...
    public List<SurvivorPaymentReviewExtCase> getBenIssueDataList() {
        return benIssueDataList;
    }

    public void setBenIssueDataList(List<SurvivorPaymentReviewExtCase> benIssueDataList) {
        this.benIssueDataList = benIssueDataList;
    }

    public List<SurvivorPaymentReviewExtCase> getBenChkDataList() {
        return benChkDataList;
    }

    public void setBenChkDataList(List<SurvivorPaymentReviewExtCase> benChkDataList) {
    ...
    public List<SurvivorPaymentReviewExtCase> getOtherChkDataList() {
        return otherChkDataList;
    }

    public void setOtherChkDataList(List<SurvivorPaymentReviewExtCase> otherChkDataList) {
        this.otherChkDataList = otherChkDataList;
    }

    public SurvivorPaymentReviewExtCase[] getBenIssueDataArray() {
        return benIssueDataArray;
    }

    public void setBenIssueDataArray(SurvivorPaymentReviewExtCase[] benIssueDataArray) {
        this.benIssueDataArray = benIssueDataArray;
    }

    public String getManchkMkCtlY() {
        return manchkMkCtlY;
    }

    public void setManchkMkCtlY(String manchkMkCtlY) {
        this.manchkMkCtlY = manchkMkCtlY;
    }

    public String getManchkMkCtlN() {
        return manchkMkCtlN;
    }

    public void setManchkMkCtlN(String manchkMkCtlN) {
        this.manchkMkCtlN = manchkMkCtlN;
    }

    public String getManchkMkCtlSpace() {
        return manchkMkCtlSpace;
    }

    public void setManchkMkCtlSpace(String manchkMkCtlSpace) {
        this.manchkMkCtlSpace = manchkMkCtlSpace;
    }
