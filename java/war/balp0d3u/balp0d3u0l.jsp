...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3U0L" />
    ...
    <html:javascript formName="MonthlyRpt32Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt32Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt32" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt32Form(this);}">
        
        <fieldset>
            <legend>&nbsp;保留遺屬年金計息存儲核定清單&nbsp;</legend> 
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt32Form.onsubmit()){document.MonthlyRpt32Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
