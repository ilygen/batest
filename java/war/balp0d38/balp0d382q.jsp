...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D382Q" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt08" method="post" onsubmit="">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
      	
        <fieldset>
            <legend>&nbsp;合格清冊線上處理狀況查詢 &nbsp;</legend>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                ...
                <tr align="center">                   
                    <td>
                        <bean:define id="list" name="<%=ConstantKey.MONTHLY_RPT08_PROGRESS_CASE_LIST%>" />
