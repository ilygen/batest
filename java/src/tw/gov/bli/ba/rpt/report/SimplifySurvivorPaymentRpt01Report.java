 ...
 * @author frank
 */
public class SimplifySurvivorPaymentRpt01Report extends ReportBase {
    ...
    public SimplifySurvivorPaymentRpt01Report() throws Exception {
        super();
        nPage = 0;
            ...
            if(benDataList.size() > 0){
            	for(PaymentQueryBenDataCase benDetailData : benDataList){
            		if(!benDetailData.getSeqNo().equals("0000") ){
                        ...
                        String Tel1 = "";
                		if(!StringUtils.isBlank(benDetailData.getTel1())){
                			Tel1 = "********";
                		}
                		String Tel2 = "";
                		if(!StringUtils.isBlank(benDetailData.getTel2())){
                			Tel2 = "********";
                		}
                        addColumn(table, 15, 1,"電話1："+Tel1, fontCh12, 0, LEFT);
                        addColumn(table, 15, 1,"電話2："+Tel2, fontCh12, 0, LEFT);
                        String commTyp = "";
                		if(!StringUtils.isBlank(benDetailData.getCommTyp())){
                			commTyp = "********************";
                		}
