...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X070F" />
    ...
    <html:javascript formName="CpiRecMaintQueryForm" page="1" />	
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/cpiRecMaintQuery" method="post" onsubmit="return validateCpiRecMaintQueryForm(this);">
	            ...
	            <tr>
                    <td colspan="3" align="right">
			            ...
			            <acl:checkButton buttonName="btnQuery">
			                <input name="btnQuery" type="button" class="button" value="確  認 " onclick="$('page').value='1'; $('method').value='doQuery'; if (document.CpiRecMaintQueryForm.onsubmit()){document.CpiRecMaintQueryForm.submit();}else{return false;}" />&nbsp;&nbsp;   
			            </acl:checkButton>
