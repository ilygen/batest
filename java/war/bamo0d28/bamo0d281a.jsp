...
<html:html lang="true">
    <head>
        <acl:setProgId progId="BAMO0D281A" />
    	...
    	<html:javascript formName="SurvivorPayeeDataUpdateDetailForm" page="1" />
         ...
         function initPayCategory() {
             ...
             $('payCategory').value = '<c:out value="${SurvivorPayeeDataUpdateDetailForm.payCategory}" />' || '1';
        ...
        function initPayType() {
            var payTyp =  '<c:out value="${SurvivorPayeeDataUpdateDetailForm.payTyp}" />' || '';
        ...
        function toggleFieldAfterRelChange(){
            ...
            switch($("benEvtRel").value) {
                ...
                case "5":
                    ...
                    break;
                case "6":
                	$("evtSection").style.display="inline";
                    $("incapableSection").style.display = "inline";
                    $('marryDate').value = '';
                    $('digaMyDate').value = '';
                    $('raiseChildMk').checked = false;
...
//                    $("savingMkSectionSpace").hide();		//計息存儲Space
		...
		if(document.getElementsByName("benNationTyp")[1].checked && document.getElementsByName("benSex")[0].checked==true){
            ...
            if(!validator.isRequiredValueEmpty('「關係」', $('benEvtRel'))){
                ...
                if ( (!frm['payCategory'][0].checked && !frm['payCategory'][1].checked ) ||
                     (frm['payCategory'][0].checked && Trim($("payTyp").value) == "") ||
       ...
       function autoTabChange(){
        ...
        //因為有可能從在學期間維護再返回此頁,返回的時候此頁的狀態需保存
        function initAll(){
            //檢核生日錯誤檔
            checkIdnoExist();
            toggleFieldAfterRelChange();
            initBenNationType();
            initCommTyp();
            initPayCategory();
                            ...
                            <tr>
                                <td align="right">
                                    ...
                                    <acl:checkButton buttonName="btnSave">
										<input name="btnSave" type="button" class="button" value="確　認" onclick="checkIdnoExist();$('page').value='1'; $('method').value='doSave'; if (document.SurvivorPayeeDataUpdateDetailForm.onsubmit() && checkRequireFields()){
                                    ...
                                    <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                                        ...
                                        <tr>
                                            ...
                                            <td id="iss">
                                                ...
                                                <span id="compel">
                                                    <input name="btnCompelData" type="button" class="button_120" value="不合格年月維護" onclick="$('page').value='1'; $('method').value='doPrepareInsertCompelData'; document.SurvivorPayeeDataUpdateDetailForm.submit();" style="display: none"/>
                                                </span>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr id="studMkSection">     
                                             <td id="iss" >
                                                     ...
                                                     <span>
                                                         <input name="btnStudterm" type="button" class="button_120" value="在學起迄年月維護" onclick="$('page').value='1'; $('method').value='doPrepareInsertStudterm'; document.SurvivorPayeeDataUpdateDetailForm.submit();" />
                                                     </span>
                                        ...
                                        <tr id="incapableSection">
                                            ...
                                            <td id="iss" colspan="2">
                                                ...
                                                <%--<span id="interdictDateSection">--%>
                                            		<%--<span id="interdictDateDesc" class="issuetitle_L_down" >受禁治產宣告日期：</span>--%>
                                        			<%--<html:text property="interdictDate" styleId="interdictDate" styleClass="textinput" size="10" maxlength="7" onblur="this.value=asc(this.value);"/>--%>
                                        		<%--</span>--%>
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            <td colspan="3" id="iss">
                                                ...
                                                <div id="accountContent2">
                                        			...
                                        			<html:text property="bankName" styleId="bankName" styleClass="textinput" size="60" maxlength="120" onblur="this.value=asc(this.value).toUpperCase();"/>                                   　   
                                    			</div>
