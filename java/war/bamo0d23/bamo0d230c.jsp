...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D230C" />
    ...
    <html:javascript formName="SurvivorApplicationDataUpdateForm" page="1" />
    ...
    function chkProcStat(procStat){
        if (procStat == '') {
            ...
            document.SurvivorApplicationDataUpdateForm.submit();
        } else if (procStat=='2') {
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" id="btnConfirm" name="btnConfirm" tabindex="5" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if (document.SurvivorApplicationDataUpdateForm.onsubmit()){getProcStat();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
