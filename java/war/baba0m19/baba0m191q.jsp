...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M191Q" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/prodSurvivorMediaOnline" method="post" onsubmit="">
        ...
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="8" align="right">
                        <acl:checkButton buttonName="btnBack">
                          <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('page').value='1';javascript:history.back();" />&nbsp;
                        </acl:checkButton>                                             
                    </td>
                </tr>                
                <bean:define id="qryForm" name="<%=ConstantKey.SURVIVOR_MEDIA_ONLINE_FORM %>" />
                <tr>
                ...
                <tr align="center">                   
                    <td colspan="4">
                        <bean:define id="list" name="<%=ConstantKey.SURVIVOR_MEDIA_ONLINE_CASE_LIST%>" />
                        <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">                            
                            ...
                            <display:column title="檔案下載" headerClass="issuetitle_L" class="issueinfo_C" style="width:8%; text-align:center;">
                                <acl:checkButton buttonName="btnDetail">
                                    <input type="button" name="btnDetail" class="button" value="檔案下載" onclick="$('page').value='1'; $('method').value='doDownload'; $('mfileName').value='<c:out value="${listItem.mfileName}" />'; document.SurvivorMediaOnlineForm.submit();" />&nbsp;
                                </acl:checkButton>                            
                            </display:column>
                            <display:column title="傳送" headerClass="issuetitle_L" class="issueinfo_C" style="width:10%; text-align:center;">
                                <acl:checkButton buttonName="btnDetail">
                                    <input type="button" name="btnDetail" class="button" value="傳送" onclick="$('page').value='1'; $('method').value='doUploadFile';$('mfileName').value='<c:out value="${listItem.mfileName}" />';$('mfileDate').value='<c:out value="${listItem.mfileDate}" />';$('ftpSeq').value='<c:out value="${listItem.ftpSeq}" />'; document.SurvivorMediaOnlineForm.submit();" />&nbsp;
                                </acl:checkButton>
                            </display:column>
