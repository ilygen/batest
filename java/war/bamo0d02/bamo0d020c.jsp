...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D020C" />
    ...
    <html:javascript formName="PaymentDataUpdateQueryForm" page="1" />                         
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/paymentDataUpdateQuery" method="post" onsubmit="return validatePaymentDataUpdateQueryForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.PaymentDataUpdateQueryForm.onsubmit()){document.PaymentDataUpdateQueryForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
