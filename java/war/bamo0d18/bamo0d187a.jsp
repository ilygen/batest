...
<html:html>
    <head>
        <acl:setProgId progId="BAMO0D187A" />
    ...
    function checkRequireFields() {
        ...
        if (Trim($("benEvtRel").value) == "2" || Trim($("benEvtRel").value) == "3" || 
            ...
            if(Trim($("benBrDate").value) > nowDate) msg += '「繼承人出生日期」：不得大於系統日期。\r\n';
            ...
            if(benBrDate > sYearTwenty){
                ...
                if (document.getElementsByName("benMarrMk")[1].checked==true){
                    ...
                    if((Trim($("grdIdnNo").value)+Trim($("grdBrDate").value)) == (Trim($("benIdnNo").value)+Trim($("benBrDate").value)))
                        msg += '「法定代理人」的身份證號與生日不得與繼承人或事故者相同。\r\n';
                    // 法定代理人與事故者比對
								...
								<td align="right">
									...
									<acl:checkButton buttonName="btnSave">
										<input name="btnSave" type="button" class="button" value="確　認"
											onclick="$('page').value='1'; $('method').value='doSaveInherit'; if (document.DisabledPayeeDataUpdateDetailForm.onsubmit() && checkRequireFields()){document.DisabledPayeeDataUpdateDetailForm.submit();}else{return false;}" />&nbsp;
                        			</acl:checkButton>
                                ...
                                <td align="center" class="table1">
                                    <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                                        ...
                                        <tr>
                                            ...
                                            <td id="iss" colspan="2">　<span class="issuetitle_L_down">繼承自受款人：</span><c:out value="${DisabledPayeeDataInheritFrom.benName}" /></td>
                                        </tr>
                                        <tr>
                                            <td id="iss" colspan="3">
                                        ...
                                        <tr>
                                        	<td id="iss">
                                                    ...
                                                    <html:text property="appDate" styleId="appDate" styleClass="textinput" size="15" maxlength="7" onblur="this.value=asc(this.value).toUpperCase();"/>
                                            </td>
                                            <td id="iss">
                                                    <span class="needtxt">＊</span><span class="issuetitle_L_down">繼承人身分證號：</span>
                                                    <html:text property="benIdnNo" styleId="benIdnNo" styleClass="textinput" size="15" maxlength="10" onblur="this.value=asc(this.value).toUpperCase();autoForeignBenSex();"/>
                                            </td>
                                            <td id="iss" colspan="2">
                                                　							<span class="issuetitle_L_down">繼承人出生日期：</span>
                                                	<html:text property="benBrDate" styleId="benBrDate" styleClass="textinput" size="10" maxlength="7" onblur="this.value=asc(this.value);"/>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td width="34%" id="iss">
                                        ...
                                        <tr>
                                            <td colspan="3" id="iss">
                                    			...
                                    			<div id="accountContent3">
                                                    ...
                                                    <html:text property="accName" styleId="accName" styleClass="textinput" size="50" maxlength="50" onchange="this.value=Trim($('payEeacc').value)" onblur="this.value=asc(this.value).toUpperCase();"/>                                    			
                                    			</div>
                                            </td>
                                        </tr>
                                        <tr>
                                        ...
                                        <tr>
                                            ...
                                            <html:text property="grdIdnNo" styleId="grdIdnNo" styleClass="textinput" size="20" maxlength="10" onblur="this.value=asc(this.value).toUpperCase();"/>
                                            </td>
