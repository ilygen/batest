...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D310L" />
    ...
    <html:javascript formName="MonthlyRpt01Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt01Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt01" method="post" onsubmit="return validateMonthlyRpt01Form(this);">
        
        <fieldset>
            <legend>&nbsp;月處理核定合格清冊 &nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt01Form.onsubmit()){document.MonthlyRpt01Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
