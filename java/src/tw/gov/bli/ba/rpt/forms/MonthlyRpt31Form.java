...
/**
 * 列印作業 - 其他類報表 - 查核失能程度通知函 - 查詢頁面 (balp0d3t0l.jsp)
 * 
 * @author KIYOMI
 */

public class MonthlyRpt31Form extends BaseValidatorForm {
    ...
    private String rptKind; // 001 無差額，002 有差額及未及入帳金額，003 有差額、無未及入帳金額
