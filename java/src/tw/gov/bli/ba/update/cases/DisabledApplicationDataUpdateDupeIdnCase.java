...
/**
 * Case for 失能年金案件資料更正 - 身分證重號資料
 * 
 * @author Goston
 */
public class DisabledApplicationDataUpdateDupeIdnCase implements Serializable {
    // BADUPEIDN
    private String apNo; // 受理編號
    private String seqNo; // 序號
    private String idnNo; // 身分證號 11碼
    ...
    public DisabledApplicationDataUpdateDupeIdnCase() {
