...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3L0L" />
    ...
    <html:javascript formName="MonthlyRpt21Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt21Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt21" method="post" onsubmit="return validateMonthlyRpt21Form(this);">
        
        <fieldset>
            <legend>&nbsp;應收款立帳清冊&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt21Form.onsubmit()){document.MonthlyRpt21Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
