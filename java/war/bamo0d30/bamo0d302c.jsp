...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D302C" />
    ...
    <html:javascript formName="SurvivorPaymentReceiveForm" page="1" /> 
...
<body scroll="no">
    ...
    <div id="mainContent">
        ...
        <div id="main" class="mainBody">
            <html:form action="/survivorPaymentReceive" method="post" onsubmit="">
                    ...
                    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                        <tr>
                            <td align="right" colspan="8">
                                <acl:checkButton buttonName="btnSave">
                                    <input name="btnSave" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doConfirmCashReceive'; if(checkFields()){document.SurvivorPaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                            </acl:checkButton>
                                &nbsp;
                                <acl:checkButton buttonName="btnBack">
                                    <input name="btnBack"  type="button"  class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack'; document.SurvivorPaymentReceiveForm.submit();" />&nbsp;
                                </acl:checkButton>
                            </td>
                        </tr>
                        <tr>
                            <td colspan="14">
                                <bean:define id="detail" name="<%=ConstantKey.SURVIVOR_PAYMENT_RECEIVE_DATA_CASE%>" />
                        ...
                        <tr>
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="8" class="issuetitle_L"><span class="systemMsg">▲</span>&nbsp;退現資料</td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.SURVIVOR_CASH_RECEIVE_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                ...
                                                <display:column title="銀行入帳日期" headerClass="issuetitle_L" class="issueinfo_C" style="width:25%; text-align:center;">
                                                    <c:out value="${listItem.bkAccountDt}" />&nbsp;
                                                </display:column>
                                                <display:column title="現金金額" headerClass="issuetitle_L" class="issueinfo_C" style="width:25%; text-align:right;">
                                                    <fmt:formatNumber value="${listItem.cash_Amt}" />
                                                </display:column>
                                                <display:column title="可用餘額" headerClass="issuetitle_L" class="issueinfo_C" style="width:25%; text-align:right;">
                        ...
                        <tr>
                            ...
                            <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.SURVIVOR_ACCOUNTS_RECEIVABLE_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                ...
                                                <display:column title="受款人序" headerClass="issuetitle_L" class="issueinfo_C" style="width:10%; text-align:center;">
                                                ...
                                                <display:column title="應收未收餘額" headerClass="issuetitle_L" class="issueinfo_C" style="width:20%; text-align:right;">
                                                    <fmt:formatNumber value="${listItem.recRem}" />
                                                </display:column>
                                                <display:column title="應收金額" headerClass="issuetitle_L" class="issueinfo_C" style="width:20%; text-align:right;">
