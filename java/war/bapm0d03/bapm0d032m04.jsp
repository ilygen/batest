                       ...
                       <tr>
		                    <td colspan="2" align="right">
		                    	<acl:checkButton buttonName="btnPrint">
		                          	<input type="button" name="btnPrint" class="button_90" value="列印畫面" onclick="javascript:window.open('<c:url value="/bapm0d03/bapm0d032m04p.jsp"/>');">   	                                        
		                    	</acl:checkButton>    
		                ...
		                <tr>
					               ...
					               <tr>
					                    <td>
					                        <table width="100%" border="0" cellpadding="3" cellspacing="5" class="px13">
					                            <tr>
                               					 <td width="84%" class="issuetitle_L"><span class="systemMsg">▲</span>各期本金分配明細</td>
												 </tr>
                        					</table>
                    					</td>
                					</tr>
							<tr align="center">
				                            ...
				                            <display:column title="核定年月" style="width:15%; text-align:right;">
					                               <c:out value="${listItem.issuYm}" />
					                        </display:column>
				                            <display:column title="給付年月" style="width:15%; text-align:right;">
					                                  <c:out value="${listItem.payYm}" />
					                        </display:column>
