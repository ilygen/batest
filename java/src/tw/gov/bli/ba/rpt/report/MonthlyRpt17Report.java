 ...
 * @author Goston
 */
public class MonthlyRpt17Report extends ReportBase {
    private String printDate = ""; // 印表日期

    public MonthlyRpt17Report() throws Exception {
        super();
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt17Case> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRpt17_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
