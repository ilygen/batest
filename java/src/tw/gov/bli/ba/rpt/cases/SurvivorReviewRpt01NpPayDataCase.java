...
/**
 * Case for 勞保遺屬年金給付受理編審清單 - 請領他類給付資料 - 申請國保給付記錄
 * 
 * @author Rickychi
 */
public class SurvivorReviewRpt01NpPayDataCase implements Serializable {
    // 國保給付主檔 (NBAPPBASE)
    // [
     ...
     * @return
     */
    public String getHandIcApDtString() {
    ...
    public SurvivorReviewRpt01NpPayDataCase() {
