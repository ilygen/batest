...
<html:html lang="true">
  <head>
  	  <acl:setProgId progId="BARE0D041L" />
      ...
      <html:javascript formName="ReviewFeeReceiptRpt02Form" page="1" />
...
<div id="mainContent">
    ...
    <html:form action="/printReviewFeeReceiptRpt02" method="post" onsubmit="return validateReviewFeeReceiptRpt02Form(this);">    
      <fieldset>
      <legend>&nbsp;複檢費用核定通知書 &nbsp;</legend>
          ...
          <tr>
              <td colspan="2" align="right">
                  ...
                  <acl:checkButton buttonName="btnPrint">
                        <input type="button" id="btnPrint" name="btnPrint" tabindex="3" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.ReviewFeeReceiptRpt02Form.onsubmit()){document.ReviewFeeReceiptRpt02Form.submit();}else{return false;}" />&nbsp;
                  </acl:checkButton>                        
