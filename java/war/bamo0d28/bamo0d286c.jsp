...
<html:html lang="true">
<head>
  <acl:setProgId progId="BAMO0D286C" />
    ...
    <script type="text/javascript">
        ...
        function resetForm() {
            document.SurvivorPayeeDataUpdateStudTermForm.reset();
            initAll();
        }
...
<body scroll="no">
    ...
    <html:form action="/survivorPayeeDataUpdateStudTerm" method="post">
      <fieldset>
              ...
              <tr>
                  <td align="right">
                      ...
                      <acl:checkButton buttonName="btnSave">
                          <input name="btnSave" type="button" class="button" value="新　增"
                                 onclick="$('page').value='1'; $('method').value='doSave'; if(checkRequireFields()){document.SurvivorPayeeDataUpdateStudTermForm.submit();} else {return false;} "/>&nbsp;
                      </acl:checkButton>
                      <acl:checkButton buttonName="btnUpdate">
                          <input name="btnUpdate" type="button" class="button" value="確　定"
                                 onclick="$('page').value='1'; $('method').value='doUpdate'; if(checkRequireFields()){document.SurvivorPayeeDataUpdateStudTermForm.submit();} else {return false;} "
                                 style="display: none;"/>&nbsp;
                      </acl:checkButton>
                      ...
                      <acl:checkButton buttonName="btnBack">
                          <input name="btnBack" type="button" class="button" value="返　回"
                                 onclick="$('page').value='1'; $('method').value='doBack'; document.SurvivorPayeeDataUpdateStudTermForm.submit();"/>
                      </acl:checkButton>
                  </td>
              </tr>
              <tr>
                      ...
                      <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                                  ...
                                  <table width="98%" cellpadding="3" cellspacing="5" class="px13">
                                      <tr>
                                          <td id="iss">
                                              ...
                                              <html:text property="studSdate" styleId="studSdate" styleClass="textinput"
                                                         size="10" maxlength="5" onblur="this.value=asc(this.value);"/>
                                              ~
                                              <html:text property="studEdate" styleId="studEdate" styleClass="textinput"
                                                         size="10" maxlength="5" onblur="this.value=asc(this.value);"/>
                          ...
                          <tr align="center">
                              <td colspan="4" class="issuetitle_L">
                                  <bean:define id="list" name="<%=ConstantKey.SURVIVOR_PAYEE_DATA_UPDATE_STUDTERM_LIST_CASE%>"/>
                                  <display:table name="pageScope.list" id="listItem" pagesize="999">
                                      ...
                                      <display:column title="在學起迄年月" headerClass="issuetitle_L" class="issueinfo_C" style="width: 45%;text-align: center;">
                                          <c:out value="${listItem.studSdateChineseStr}"/> ~ <c:out value="${listItem.studEdateChineseStr}"/>
                                      </display:column>
                                      <display:column title="操作區" headerClass="issuetitle_L" class="issueinfo_C" style="width: 40%; text-align: center;">
                                          <acl:checkButton buttonName="btnUpdateStudTerm">
                                              <input type="button" class="button_90" name="btnUpdateStudTerm"
                                                     value="修　改"
                                                     onclick="$('termNo').value='<c:out value="${listItem.termNo}"/>'; toggleUpdateMode('<c:out value="${listItem_rowNum}"/>'); $('studSdate').focus(); ">
                                          </acl:checkButton>
                                          <acl:checkButton buttonName="btnDeleteStudTerm">
                                              <input type="button" class="button_90" name="btnDeleteStudTerm"
                                                     value="刪　除"
                                                     onclick="$('method').value='doDelete'; $('termNo').value='<c:out value="${listItem.termNo}"/>'; document.SurvivorPayeeDataUpdateStudTermForm.submit();">
                                          </acl:checkButton>
                                      </display:column>
                                  </display:table>
                              </td>
