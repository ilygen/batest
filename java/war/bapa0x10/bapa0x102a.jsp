...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X102A" />
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/survivorBasicAmtMaintDetail" method="post" onsubmit="return validateBasicAmtMaintDetailForm(this);">
        
        <fieldset>
            <legend>&nbsp;遺屬年金基本金額調整作業新增&nbsp;</legend>
