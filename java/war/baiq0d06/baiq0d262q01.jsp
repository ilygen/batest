...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D262Q01" />
                                        ...
                                        <tr>
                                            ...
                                            <td id="iss" colspan="2">
                                                ...
                                                <c:if test="${(benDetailData.compelSdate ne '')or(benDetailData.compelEdate ne '')}">
                                                    <a href="<c:url value="/paymentQuerySimplify.do?method=doSurvivorCompelNopayDetailData&apNo=${benDetailData.apNo}&seqNo=${benDetailData.seqNo}" />" title="連結至：強迫不合格起迄年月" target="_self">
                                        ...
                                        <tr>
                                            <td id="iss" colspan="2">
                                                ...
                                                <c:if test="${(benDetailData.studSdate ne '')or(benDetailData.studEdate ne '')}">
                                                    <a href="<c:url value="/paymentQuerySimplify.do?method=doSurvivorStudDetailData&apNo=${benDetailData.apNo}&seqNo=${benDetailData.seqNo}" />" title="連結至：在學起迄年月" target="_self">
