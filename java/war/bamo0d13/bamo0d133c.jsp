...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D133C" />
    ...
    <html:javascript formName="DisabledApplicationDataUpdateForm" page="3" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/disabledApplicationDataUpdate" method="post">
                ...
                <tr>
                    <td align="right" colspan="5">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" id="btnConfirm" name="btnConfirm" tabindex="999" class="button" value="確　認" onclick="$('page').value='3'; $('method').value='doSelectDupe'; document.DisabledApplicationDataUpdateForm.submit();" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnBack">
                            <input type="button" id="btnBack" name="btnBack" tabindex="1000" class="button" value="返　回" onclick="$('page').value='3'; $('method').value='doBackToDetail'; document.DisabledApplicationDataUpdateForm.submit();" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <bean:write name="DisabledApplicationDataUpdateForm" property="evtIdnNo" />
                                </td>
                            </tr>
                        </table>
                    </td>
