...
/**
 * 給付核定檔 (<code>BBDAPR</code>)
 * 
 * @author swim
 */
@Table("BBDAPR")
public class Bbdapr implements Serializable {
    private BigDecimal badaprId; // 資料列編號

    @PkeyField("BBDAPRID")
    private BigDecimal bbdaprId; // 給付主檔資料編號
    ...
    public BigDecimal getBbdaprId() {
        return bbdaprId;
    }

    public void setBbdaprId(BigDecimal bbdaprId) {
        this.bbdaprId = bbdaprId;
    }
