...
<html:html lang="true">
  <head>
  	  <acl:setProgId progId="BARE0D040L" />
      ...
      <html:javascript formName="ReviewFeeReceiptRpt01Form" page="1" />
...
<div id="mainContent">
    ...
    <html:form action="/printReviewFeeReceiptRpt01" method="post" onsubmit="return validateReviewFeeReceiptRpt01Form(this);">  
      <fieldset>
      <legend>&nbsp;複檢費用受理審核清單 &nbsp;</legend>
          ...
          <tr>
              <td colspan="2" align="right">
                  ...
                  <acl:checkButton buttonName="btnPrint">
                            <input type="button" id="btnPrint" name="btnPrint" tabindex="3" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.ReviewFeeReceiptRpt01Form.onsubmit()){document.ReviewFeeReceiptRpt01Form.submit();}else{return false;}" />&nbsp;
                  </acl:checkButton>                        
