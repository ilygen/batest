...
public class MonthlyRptS10Type3Report extends ReportBase {

    private String printDate = ""; // 印表日期

    // private HashMap<String, MonthlyRpt10Type1PayAmtCase> payAmtMap; // 代扣補償金

    public MonthlyRptS10Type3Report() throws Exception {
        super();
    ...
    public Table addHeader(MonthlyRpt10Type3RptCase caseData) throws Exception {
        ...
        // }
        addColumn(table, 42, 1, "　", fontCh10, 0, LEFT);
    ...
    // public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt10Type3RptCase> caseList, HashMap<String, MonthlyRpt10Type1PayAmtCase> payAmtMap) throws Exception {
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt10Type3RptCase> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptK10Type3_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
