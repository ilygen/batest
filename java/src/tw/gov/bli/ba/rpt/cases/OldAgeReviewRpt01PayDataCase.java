...
/**
 * Case for 勞保老年年金給付受理編審清單 - 給付資料
 * 
 * @author Goston
 */
public class OldAgeReviewRpt01PayDataCase implements Serializable {
    private String payYm; // 給付年月
    private BigDecimal issueAmt; // 核定金額
    private BigDecimal issuCalcAmt; // 物價調整金額
    ...
    public OldAgeReviewRpt01PayDataCase() {
