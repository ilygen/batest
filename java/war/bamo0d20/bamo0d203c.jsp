...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D203C" />
                        ...
                        <tr>
                            <td align="right" colspan="8">
                                <acl:checkButton buttonName="btnSave">
                                    <input name="btnSave" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doCancelRemittanceReceive'; if(checkFields()){document.DisabledPaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                            </acl:checkButton>
                                &nbsp;
