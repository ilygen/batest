...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D300C" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/survivorPaymentReceive" method="post" onsubmit="return validateSurvivorPaymentReceiveForm(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;遺屬年金應收收回處理&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.SurvivorPaymentReceiveForm.onsubmit() && checkFields()){document.SurvivorPaymentReceiveForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnSave">
                            <input type="button" name="btnQuery" class="button" value="註　銷" onclick="$('page').value='1'; $('method').value='doCancel'; if(document.SurvivorPaymentReceiveForm.onsubmit() && checkFields()){document.SurvivorPaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                    </acl:checkButton>
	                    &nbsp;
