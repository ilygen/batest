...
public class FtpHelper {
    ...
    public String[] getTxtFileContent(String fileName, String dirForTxtDownload) {
        ...
        try {
            ...
            if (is != null) {
                ...
                log.error("欲從 FTP 取得的檔案不存在, 檔案名稱: " + StringUtils.defaultString(Encode.forJava(fileName)));
    ...
    public void backupFile(String fileName) {
        ...
        try {
            ...
            if (!bOperation)
                log.info("資料文字檔" + Encode.forJava(fileName) + "檔案搬移失敗 Code:" + ftp.getReplyCode() + "備份檔案路徑：" + dirForDataFileBackup);
            else
