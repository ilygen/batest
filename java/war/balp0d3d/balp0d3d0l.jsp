...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3D0L" />
    ...
    <html:javascript formName="MonthlyRpt13Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt13Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt13" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt13Form(this);}">
        
        <fieldset>
            <legend>&nbsp;改匯核定清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt13Form.onsubmit()){document.MonthlyRpt13Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
