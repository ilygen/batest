...
<html:html lang="true">
<head>
<acl:setProgId progId="BABA0M242C" />
...
<body scroll="no">
	...
	<div id="mainContent">
		...
		<div id="main" class="mainBody">
			<html:form action="/oldAgePayment" method="post" onsubmit="return validateCompPaymentForm(this);">
				<html:hidden styleId="page" property="page" value="1" />
				<html:hidden styleId="method" property="method" value="" />
				<fieldset>
					<legend>&nbsp;老年年金補正核付修改作業&nbsp;</legend>
                            ...
                            <td colspan="7">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                                    <tr>
                                        ...
                                        <td><span class="issuetitle_L_down">給付別：</span>老年年金</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
