...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D520L" />
    ...
    <html:javascript formName="OtherRpt02Form" page="1" />
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printOtherRpt02" method="post" onsubmit="return validateOtherRpt02Form(this);">
        
        <fieldset>
            <legend>&nbsp;已退匯或退回現金尚未沖轉收回案件清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.OtherRpt02Form.onsubmit()){document.OtherRpt02Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
