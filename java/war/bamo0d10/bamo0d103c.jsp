...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D103C" />
                        ...
                        <tr>
                            <td align="right" colspan="8">
                                <acl:checkButton buttonName="btnSave">
                                    <input name="btnSave" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doCancelRemittanceReceive'; if(checkFields()){document.OldAgePaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                            </acl:checkButton>
                                &nbsp;
                                ...
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.REMITTANCE_RECEIVE_DATA_CASE_LIST%>" />
