...
/**
 * Case for 失能年金編審註記程度調整 - 眷屬編審註記資料
 * 
 * @author Goston
 */
public class DisabledCheckMarkLevelAdjustFamDetailDataCase implements Serializable {
    ...
    public DisabledCheckMarkLevelAdjustFamDetailDataCase() {
