...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3V0L" />
    ...
    <html:javascript formName="MonthlyRpt33Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt33Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt33" method="post" onsubmit="return validateMonthlyRpt33Form(this);">
        
        <fieldset>
            <legend>&nbsp;保留遺屬年金計息存儲清冊&nbsp;</legend> 
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt33Form.onsubmit()){document.MonthlyRpt33Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
