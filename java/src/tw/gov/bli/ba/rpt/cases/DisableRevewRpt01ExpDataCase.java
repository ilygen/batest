...
/**
 * Case for 勞保失能年金給付受理編審清單 - 給付延伸資料
 * 
 * @author Evelyn Hsu
 */

public class DisableRevewRpt01ExpDataCase implements Serializable{
    ...
    private String ocAccHosId;       //職病醫院代碼
    private String ocAccDoctorName1;//職病醫生姓名1
    private String ocAccDoctorName2;//職病醫生姓名2    
    private String prType;        //先核普通
    private String hpName;      //醫院名稱
    private String ocAccHpName;      //職病醫院名稱
    ...
    public String getOcAccHpName() {
        return ocAccHpName;
    }

    public void setOcAccHpName(String ocAccHpName) {
        this.ocAccHpName = ocAccHpName;
    }    
