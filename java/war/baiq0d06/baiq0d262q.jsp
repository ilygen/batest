...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D262Q" />
                        ...
                        <tr>
                            ...
                            <td align="right" >
                                <acl:checkButton buttonName="btnPrint">
                                    <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReportSimplifySurvivorApplicationData'; document.PaymentQueryForm.submit();"/>&nbsp;
                                </acl:checkButton>
                                        ...
                                        <td colspan="4">
                                           <table width="100%" cellpadding="0" cellspacing="0" class="px13">
                                                ...
                                                <td width="12%" valign="bottom" class="issuetitle_L" id="tabsJ">
                                                    <a href="<c:url value="/executiveSupportQueryQuery.do?method=doQuery&qryFromWhere=BAIQ0D262Q&apNo=${detail.apNo}&issuYm=${detail.issuYmStr}" />" target="_self">
                                                        <span>行政支援查詢</span>
                                                    </a>
                                                </td>
                                            </table>
