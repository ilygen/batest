...
<html:html lang="true">
<head>
    <acl:setProgId progId="BACO0D013Q01" />
                ...
                <tr>
                    <td colspan="7" align="center" class="table1">
                        <table width="98%" cellpadding="3" cellspacing="5" class="px13">
                            ...
                            <logic:notEmpty name="<%=ConstantKey.PAYMENT_REVIEW_ONCEPAY_DETAIL_DATA_CASE%>">
                            <bean:define id="oncePay" name="<%=ConstantKey.PAYMENT_REVIEW_ONCEPAY_DETAIL_DATA_CASE%>" />
                                <tr>
                                    <td width="25%" id="iss">
                                        <span class="issuetitle_L_down">受理編號：</span>
                                        <c:out value="${oncePay.bmApNo}" />&nbsp;
                                    </td>
                                    <td width="25%" id="iss">
                                ...
                                <tr>
                                    <td id="iss">
                                        ...
                                        <c:out value="${oncePay.bmNrepDateStr}" />&nbsp;/&nbsp;<c:out value="${oncePay.bmNdocMk}" />
                                    </td>
                                    <td id="iss">
                            ...
                            <logic:iterate id="annuPay" name="<%=ConstantKey.PAYMENT_REVIEW_ANNUITYPAY_DATA_CASE_LIST%>" >
                                <tr>
                                    <td id="iss" colspan="4">                                
                                ...
                                <tr>
                                    ...
                                    <td id="iss_b">
                                        <span class="issuetitle_L_down">補件日期/註記：</span>
                                        <c:out value="${annuPay.proDateStr}" />
                                        <c:if test="${(annuPay.proDateStr ne '')or(annuPay.ndomk1 ne '')}">
                                        &nbsp;/&nbsp;
                                        </c:if>
                                        <c:out value="${annuPay.ndomk1}" />&nbsp;
                                    </td>
                            ...
                            <logic:iterate id="criPay" name="<%=ConstantKey.PAYMENT_REVIEW_CRIPAY_APPLY_DATA_CASE_LIST%>" >
                                <tr>
                                    <td id="iss" colspan="2">
                                        <span class="issuetitle_L_down">受理編號/給付年月：</span>
                                        <c:out value="${criPay.bmApNo}" />&nbsp;
                                    </td>
                                    <td id="iss">
                            ...
                            <logic:notEmpty name="<%=ConstantKey.PAYMENT_REVIEW_DIEPAY_APPLY_DATA_CASE%>">                            
                            <bean:define id="diePay" name="<%=ConstantKey.PAYMENT_REVIEW_DIEPAY_APPLY_DATA_CASE%>" />
                                <tr>
                                    <td id="iss" colspan="2">
                                        <span class="issuetitle_L_down">受理編號/給付年月：</span>
                                        <c:out value="${diePay.bmApNo}" />&nbsp;
                                    </td>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">申請日期：</span>
                            ...
                            <logic:iterate id="injPay" name="<%=ConstantKey.PAYMENT_REVIEW_INJPAY_APPLY_DATA_CASE_LIST%>" >
                                <tr>
                                    <td id="iss" colspan="4">
                                        <span class="issuetitle_L_down">受理編號/給付年月：</span>
                                        <c:out value="${injPay.bmApNo}" />&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td id="iss">
                            ...
                            <logic:iterate id="unEmpPay" name="<%=ConstantKey.PAYMENT_REVIEW_UNEMPPAY_APPLY_DATA_CASE_LIST%>" >
                                <tr>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">受理編號：</span>
                                        <c:out value="${unEmpPay.apNo}" />&nbsp;
                                    </td>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">申請日期：</span>
                                        <c:out value="${unEmpPay.apDte}" />&nbsp;
                                    </td>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">事故者姓名：</span>
                                    ...
                                    <td id="iss">
                                        ...
                                        <c:out value="${unEmpPay.aprDte}" />&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">給付起迄日：</span>
                                        <c:out value="${unEmpPay.symDte}" />
                                        <c:if test="${(unEmpPay.symDte ne '')or(unEmpPay.tymDte ne '')}">
                                        &nbsp;~&nbsp;
                                        </c:if>
                                        <c:out value="${unEmpPay.tymDte}" />&nbsp;
                                    </td>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">核定金額：</span>
                                    ...
                                    <td id="iss">
                                        <span class="issuetitle_L_down">核定日期：</span>
                                        <c:out value="${unEmpPay.chkDte}" />&nbsp;
                                    </td>
                                    <td id="iss">
                                        <span class="issuetitle_L_down">核付日期：</span>
                                        <c:out value="${unEmpPay.payDte}" />&nbsp;
                                    </td>
                                </tr>
                                <tr>
                                    <td id="iss_b" colspan="2">
                                        <span class="issuetitle_L_down">補件日期/註記：</span>
                                        <c:out value="${unEmpPay.savDt1}" />
                                        <c:if test="${(unEmpPay.savDt1 ne '')or(unEmpPay.ndcMrk ne '')}">
                                        &nbsp;/&nbsp;
                                        </c:if>
                                        <c:out value="${unEmpPay.ndcMrk}" />&nbsp;
                                    </td>
                                    <td id="iss_b" colspan="2">
                                        <span class="issuetitle_L_down">不給付日期：</span>
                                        <c:out value="${unEmpPay.npyDte}" />&nbsp;
                                    </td>
                                </tr>
                            </logic:iterate>
                            <tr>
                            ...
                            <logic:notEmpty name="<%=ConstantKey.PAYMENT_REVIEW_NPPAY_APPLY_DATA_CASE%>">
                            <bean:define id="npPay" name="<%=ConstantKey.PAYMENT_REVIEW_NPPAY_APPLY_DATA_CASE%>" />
                                <tr>
                                    <td id="iss" colspan="4">
                                        <span class="issuetitle_L_down">受理編號/給付年月：</span>
                                        <c:out value="${npPay.apNo}" />
                                        <c:if test="${(npPay.apNo ne '')or(npPay.payYmStr ne '')}">
                                        &nbsp;/&nbsp;
                                        </c:if>
