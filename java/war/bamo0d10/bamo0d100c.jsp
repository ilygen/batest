...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D100C" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/oldAgePaymentReceive" method="post" onsubmit="return validateOldAgePaymentReceiveForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="收　回" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.OldAgePaymentReceiveForm.onsubmit() && checkFields()){document.OldAgePaymentReceiveForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnSave">
                            <input type="button" name="btnQuery" class="button" value="註　銷" onclick="$('page').value='1'; $('method').value='doCancel'; if(document.OldAgePaymentReceiveForm.onsubmit() && checkFields()){document.OldAgePaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                    </acl:checkButton>
	                    &nbsp;
