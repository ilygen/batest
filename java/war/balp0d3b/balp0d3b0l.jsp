...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3B0L" />
    ...
    <html:javascript formName="MonthlyRpt11Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt11Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt11" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt11Form(this);}">
        
        <fieldset>
            <legend>&nbsp;退匯核定清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt11Form.onsubmit()){document.MonthlyRpt11Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
