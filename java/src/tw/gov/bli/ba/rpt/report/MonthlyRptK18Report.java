 ...
 * @author Goston
 */
public class MonthlyRptK18Report extends ReportBase {
    private String printDate = ""; // 印表日期

    public MonthlyRptK18Report() throws Exception {
        super();
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt18Case> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptK18_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
