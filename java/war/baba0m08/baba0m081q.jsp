...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M081Q" />
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doConfirm'; if (checkFields()){document.MonthCheckLForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                ...
                <tr align="center">
                    <td>
                        ...
                        <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">
                            ...
                            <display:column title="最新核定年月" style="width:9%; text-align:center;">
