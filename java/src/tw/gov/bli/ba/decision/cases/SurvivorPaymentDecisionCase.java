 ...
 * @author Rickychi
 */
public class SurvivorPaymentDecisionCase implements Serializable {
    ...
    private List<SurvivorPaymentDecisionExtCase> benIssueDataList;// 受款人核定資料
    private List<SurvivorPaymentDecisionExtCase> benChkDataList;// 受款人的編審註記
    private List<SurvivorPaymentDecisionExtCase> otherChkDataList;// 眷屬編審註記/符合註記
    private SurvivorPaymentDecisionExtCase[] benIssueDataArray;// 受款人核定資料Array
    ...
    private String isShowReChk;// 複核RADIO是否顯示
    private String isShowExeMk;// 決行RADIO是否顯示

    private String balp0d020Id;// 審核清單編號
    ...
    public String getProcStatStr() {
        String tmpProcStatStr = getProcStat();
    ...
    public List<SurvivorPaymentDecisionExtCase> getBenIssueDataList() {
        return benIssueDataList;
    }

    public void setBenIssueDataList(List<SurvivorPaymentDecisionExtCase> benIssueDataList) {
        this.benIssueDataList = benIssueDataList;
    }

    public List<SurvivorPaymentDecisionExtCase> getBenChkDataList() {
        return benChkDataList;
    }

    public void setBenChkDataList(List<SurvivorPaymentDecisionExtCase> benChkDataList) {
    ...
    public String getIsShowReChk() {
        return isShowReChk;
    }

    public void setIsShowReChk(String isShowReChk) {
        this.isShowReChk = isShowReChk;
    }

    public String getIsShowExeMk() {
        return isShowExeMk;
    }

    public void setIsShowExeMk(String isShowExeMk) {
        this.isShowExeMk = isShowExeMk;
    }
    ...
    public String getBalp0d020Id() {
        return balp0d020Id;
    }

    public void setBalp0d020Id(String balp0d020Id) {
    ...
    public List<SurvivorPaymentDecisionExtCase> getOtherChkDataList() {
        return otherChkDataList;
    }

    public void setOtherChkDataList(List<SurvivorPaymentDecisionExtCase> otherChkDataList) {
        this.otherChkDataList = otherChkDataList;
    }

    public SurvivorPaymentDecisionExtCase[] getBenIssueDataArray() {
        return benIssueDataArray;
    }

    public void setBenIssueDataArray(SurvivorPaymentDecisionExtCase[] benIssueDataArray) {
