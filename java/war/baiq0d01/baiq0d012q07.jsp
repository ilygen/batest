...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D012Q07" />
                        ...
                        <tr>
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="8" class="issuetitle_L"><span class="systemMsg">▲</span>&nbsp;物價指數調整資料</td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.PAYMENT_QUERY_CPI_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                ...
                                                <display:column title="給付年月" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:center;">
                                                    <c:out value="${listItem.nowPayYmStr}" />&nbsp;
                                                </display:column>                   
                                                <display:column title="核定金額" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:right;">
                                                    <fmt:formatNumber value="${listItem.nowIssueAmt}" />&nbsp;
                                                </display:column>
                                                <display:column title="物價調整前金額" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:right;">
                                                    <fmt:formatNumber value="${listItem.lastIssueAmt}" />&nbsp;
                                                </display:column>
                                                <display:column title="調整指數" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:right;">
                                                    <fmt:formatNumber value="${listItem.cpiRate}" />
                                                    <c:if test="${listItem.cpiRate ne null}">%</c:if>&nbsp;
                                                </display:column>
                                            </display:table>
                                        </td>
                                    </tr>
