...
<html:html lang="true">
<head>
    <acl:setProgId progId="BARE0D030A" />
    ...
    <html:javascript formName="ReviewFeeDecisionForm" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/reviewFeeDecision" method="post" onsubmit="return validateReviewFeeDecisionForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" id="btnConfirm" name="btnConfirm" tabindex="5" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if (document.ReviewFeeDecisionForm.onsubmit()){document.ReviewFeeDecisionForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
