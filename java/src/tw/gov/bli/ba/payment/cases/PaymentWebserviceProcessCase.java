...
/**
 * Case for 繳款單 webservice
 * 
 * @author Zehua
 */
public class PaymentWebserviceProcessCase implements Serializable{
	private String edate;//入帳日期
	private BigDecimal amt;//應繳總金額
	private String sitDte;//繳納日期
	private String barCode1;//條碼一
	private String barCode2;//條碼二
	private String barCode3;//條碼三
	private String pno;	//員工編號
	private String accptIssueKind;//收繳核發種類
	private String waitMk;//待確認註記 Y:不確定(不印核定清單) N:已分割"
	private String divMrk;//分割註記"是否為分割欄位(Y/N)Y是分割/N表不分割。"
	...
	private List<PaymentWebserviceDtlCase> dtlCase;	
	public List<PaymentWebserviceDtlCase> getDtlCase() {
		return dtlCase;
	}
	public void setDtlCase(List<PaymentWebserviceDtlCase> dtlCase) {
		this.dtlCase = dtlCase;
	}
	public String getAccptIssueKind() {
		return accptIssueKind;
	}
	public void setAccptIssueKind(String accptIssueKind) {
		this.accptIssueKind = accptIssueKind;
	}
