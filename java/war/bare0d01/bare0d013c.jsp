...
<html:html lang="true">
<head>
    <acl:setProgId progId="BARE0D013C" />
    ...
    function doRefillValue() {
        // 通訊地址欄位處理
        // [
        var commTyp = '<c:out value="${sessionScope.ReviewFeeReceiptForm.commTyp}" />';
        var commZip = '<c:out value="${sessionScope.ReviewFeeReceiptForm.commZip}" />';
        var commAddr = '<c:out value="${sessionScope.ReviewFeeReceiptForm.commAddr}" />';
        setRadioValue("commTyp", commTyp);
        
        if (commTyp == "2") {
            $("commZip").value = commZip;
            $("commAddr").value = commAddr;
        }
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td align="right">
                        ...
                        <html:hidden styleId="reApNo" property="reApNo" />
                        <html:hidden styleId="apSeq" property="apSeq" />
                        <html:hidden styleId="apNo" property="apNo" />
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" id="btnConfirm" name="btnConfirm" tabindex="100" class="button" value="確　認" onclick="$('page').value='2'; $('method').value='doUpdate'; if (document.ReviewFeeReceiptForm.onsubmit() && checkFields()){document.ReviewFeeReceiptForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnDelete">
                            <input type="button" id="btnDelete" name="btnDelete" tabindex="101" class="button" value="刪　除" onclick="$('page').value='2'; $('method').value='doDelete'; if (confirm('確定刪除？')) { document.ReviewFeeReceiptForm.submit(); } else {return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnBack">
                            <input type="button" id="btnBack" name="btnBack" tabindex="102" class="button" value="返　回" onclick="$('page').value='2'; $('method').value='doBackToListPage'; if (confirm('確定離開？')) { document.ReviewFeeReceiptForm.submit(); } else {return false;}" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                            <tr>
                                ...
                                <td colspan="3">
                                    ...
                                    <c:out value="${sessionScope.ReviewFeeReceiptForm.apSeq}" />
                                </td>
                            </tr>
                            <tr>
                                <td>
                        ...
                        <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                            ...
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldInreDate" property="oldInreDate" />
                                </td>
                                <td id="iss" colspan="2">
                                    <span class="needtxt">＊</span>
                                    ...
                                    <html:hidden styleId="oldReasCode" property="oldReasCode" />
                                </td>
                            </tr>
                            <tr>
                                <td id="iss" colspan="3">
                            ...
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldRecosDate" property="oldRecosDate" />
                                </td>
                                <td id="iss">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldReNum" property="oldReNum" />
                                </td>
                                <td id="iss">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldRehpStay" property="oldRehpStay" />
                                </td>
                            </tr>
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldReFees" property="oldReFees" />
                                </td>
                                <td id="iss"  colspan="2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldNonreFees" property="oldNonreFees" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" class="issuetitle_L">
                            ...
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldBenEvtRel" property="oldBenEvtRel" />
                                </td>
                                <td id="iss" colspan="2">
                                    <span class="needtxt">＊</span>
                            ...
                            <tr>
                                <td id="iss" colspan="3">
                                    ...
                                    <html:hidden styleId="oldBenName" property="oldBenName" />
                                </td>
                            <tr>
                                <td id="iss">
                                    <span class="needtxt">＊</span>
                                    ...
                                    <html:hidden styleId="oldBenIdnNo" property="oldBenIdnNo" />
                                </td>
                                <td id="iss" colspan="2">
                                    <span class="needtxt">＊</span>
                                    ...
                                    <html:hidden styleId="oldBenBrDate" property="oldBenBrDate" />
                                </td>
                            </tr>
                            <tr>
                                <td width="33%" id="iss">
                                    ...
                                    <html:hidden styleId="oldBenNationTyp" property="oldBenNationTyp" />
                                </td>
                                <td width="33%" id="iss">
                                    <div id="divSex">
                                        &nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldBenSex" property="oldBenSex" />
                                </td>
                                <td width="34%" id="iss">
                                    <div id="divNation">
                                        &nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldBenNationCode" property="oldBenNationCode" />
                                    <html:hidden styleId="oldTmpBenNationCode" property="oldTmpBenNationCode" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" id="iss">
                                    ...
                                    <html:hidden styleId="oldPayTyp" property="oldPayTyp" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3">
                                    ...
                                    <html:hidden styleId="oldAccountNo1" property="oldAccountNo1" />
                                    <html:hidden styleId="oldAccountNo2" property="oldAccountNo2" />
                                    <html:hidden styleId="oldBankName" property="oldBankName" />
                                    <html:hidden styleId="oldAccName" property="oldAccName" />
                                </td>
                            </tr>
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldTel1" property="oldTel1" />
                                </td>
                                <td id="iss" colspan="2">
                                    &nbsp;&nbsp;&nbsp;&nbsp;
                                    ...
                                    <html:hidden styleId="oldTel2" property="oldTel2" />
                                </td>
                            </tr>
                            <tr>
                                <td id="iss">
                                    ...
                                    <html:hidden styleId="oldCommTyp" property="oldCommTyp" />
                                </td>
                                <td id="iss" colspan="2">
                                    <div id="divCommAddr">
                                        <span class="formtxt">
                                    ...
                                    <html:hidden styleId="oldCommZip" property="oldCommZip" />
                                    <html:hidden styleId="oldCommAddr" property="oldCommAddr" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3"></td>
