...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M210X" />
    ...
    <html:javascript formName="CheckJobForm" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/checkJob" method="post" onsubmit="return validateCheckJobForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" id="btnQuery" name="btnQuery" tabindex="3" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if (document.CheckJobForm.onsubmit()){document.CheckJobForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
