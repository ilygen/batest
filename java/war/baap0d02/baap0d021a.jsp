...
<html:html lang="true">                                                                                                                                                                                                                                                                                                                                       
<head>                                                                                                                                                                                                                                                                                                                                                        
    <acl:setProgId progId="BAAP0D021A" />                                                                                                                                                                                                                                                                                                                     
                ...
                <tr>                                                                                                                                                                                                                                                                                                                                          
                    <td colspan="2" align="right">                                                                                                                                                                                                                                                                                                            
                        <acl:checkButton buttonName="btnConfirm">                                                                                                                                                                                                                                                                                             
                            <input tabindex="700" type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doInsert'; if (document.DisabledAnnuityReceiptForm.onsubmit() && checkFields() && isValidEvtDateTrue()){document.DisabledAnnuityReceiptForm.submit();}else{return false;}" />&nbsp;                                  
                        </acl:checkButton>                                                                                                                                                                                                                                                                                                                    
                        ...
                        <acl:checkButton buttonName="btnBack">                                                                                                                                                                                                                                                                                                
                            <input tabindex="720" type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack'; document.DisabledAnnuityReceiptForm.submit();"/>                                                                                                                                       
                        </acl:checkButton>                                                                                                                                                                                                                                                                                                                    
                    </td>                                                                                                                                                                                                                                                                                                                                     
                </tr>                                                                                                                                                                                                                                                                                                                                         
                <tr>                                                                                                                                                                                                                                                                                                                                          
