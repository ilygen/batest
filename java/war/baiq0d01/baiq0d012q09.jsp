...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D012Q09" />
                        ...
                        <tr>
                            ...
                            <td align="right" >
                                <acl:checkButton buttonName="btnPrint">
                                    <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReportFileList'; document.PaymentQueryForm.submit();"/>&nbsp;
                                </acl:checkButton>
