...
/**
 * Case for 勞保遺屬年金給付受理編審清單 - 請領他類給付資料 - 申請死亡給付記錄
 * 
 * @author Evelyn Hsu
 */

public class SurvivorReviewRpt01DiePayDataCase implements Serializable {
    ...
    public SurvivorReviewRpt01DiePayDataCase(){
