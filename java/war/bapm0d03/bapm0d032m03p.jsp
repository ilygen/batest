        ...
        <table border="0" align="center" cellpadding="2" cellspacing="2">
               ...
               <tr>
                ...
                <tr align="center">
                    ...
                    <td width="181"><strong>繳款期限</strong></font></td>
                    <td width="181"><strong>每期本金</strong></font></td>
                    <td width="181"><strong>利息</strong></font></td>
                    <td width="185"><strong>執行費</strong></font></td>
                </tr>
                <tr>
                    <td><hr size="1" noshade></td>
                    <td><hr size="1" noshade></td>
                ...
                <logic:iterate id="listItemj" indexId="j"  name="<%=ConstantKey.PAYMENT_ASSIGN_DETAIL_CASE_LIST%>">
                <tr> 
                    <td align="center"><c:out value="${listItemj.nowStage}" /></td>
                    <td align="center"><c:out value="${listItemj.paymentNoDetail}" /></td>
                    <td align="center"><c:out value="${listItemj.paymentDateLine}" /></td>
                    <td align="right"><fmt:formatNumber value="${listItemj.rePayAmt}" /></td>
                    <td align="right"><fmt:formatNumber value="${listItemj.payInterest}" /></td>
                    <td align="right"><fmt:formatNumber value="${listItemj.execAmt}" /></td>
                </tr>
                </logic:iterate>
               <tr>
                    <td><hr size="1" noshade></td>
