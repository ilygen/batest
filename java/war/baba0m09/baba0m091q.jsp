...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M091Q" />
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doConfirm'; if (checkFields()){document.MonthCheckKForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
