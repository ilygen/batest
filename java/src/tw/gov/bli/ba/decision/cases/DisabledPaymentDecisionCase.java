 ...
 * @author Rickychi
 */
public class DisabledPaymentDecisionCase implements Serializable {
    ...
    private List<DisabledPaymentDecisionExtCase> benIssueDataList;// 受款人核定資料
    private List<DisabledPaymentDecisionExtCase> benChkDataList;// 受款人的編審註記
    private List<DisabledPaymentDecisionExtCase> otherChkDataList;// 眷屬編審註記/符合註記
    ...
    public String getPayYmsStr() {
        if (StringUtils.isNotBlank(getPayYms())) {
    ...
    public String getPayYmeStr() {
        if (StringUtils.isNotBlank(getPayYme())) {
    ...
    public String getPauseYmStr() {
        if (StringUtils.isNotBlank(getPauseYm())) {
    ...
    public String getUnPauseYmStr() {
        if (StringUtils.isNotBlank(getUnPauseYm())) {
    ...
    public String getMaxPayYmStr() {
        if (StringUtils.isNotBlank(getMaxPayYm())) {
    ...
    public String getMinPayYmStr() {
        if (StringUtils.isNotBlank(getMinPayYm())) {
    ...
    public List<DisabledPaymentDecisionExtCase> getBenIssueDataList() {
        return benIssueDataList;
    }

    public void setBenIssueDataList(List<DisabledPaymentDecisionExtCase> benIssueDataList) {
        this.benIssueDataList = benIssueDataList;
    }

    public List<DisabledPaymentDecisionExtCase> getBenChkDataList() {
        return benChkDataList;
    }

    public void setBenChkDataList(List<DisabledPaymentDecisionExtCase> benChkDataList) {
    ...
    public List<DisabledPaymentDecisionExtCase> getOtherChkDataList() {
        return otherChkDataList;
    }

    public void setOtherChkDataList(List<DisabledPaymentDecisionExtCase> otherChkDataList) {
