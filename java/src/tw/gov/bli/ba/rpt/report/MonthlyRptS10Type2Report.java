 ...
 * @author Goston
 */
public class MonthlyRptS10Type2Report extends ReportBase {
    private String printDate = ""; // 印表日期

    // private HashMap<String, MonthlyRpt10Type2PayAmtCase> payAmtMap; // 代扣補償金

    public MonthlyRptS10Type2Report() throws Exception {
        super();
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt10Type2RptCase> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptK10Type2_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
