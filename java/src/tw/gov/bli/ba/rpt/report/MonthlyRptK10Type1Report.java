 ...
 * @author Goston
 */
public class MonthlyRptK10Type1Report extends ReportBase {
    private String printDate = ""; // 印表日期

    // private HashMap<String, MonthlyRpt10Type1PayAmtCase> payAmtMap; // 代扣補償金

    public MonthlyRptK10Type1Report() throws Exception {
        super();
    ...
    // public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt10Type1RptCase> caseList, HashMap<String, MonthlyRpt10Type1PayAmtCase> payAmtMap) throws Exception {
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt10Type1RptCase> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptK10Type1_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
