...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D120L" />
    ...
    <html:javascript formName="DataUpdateRpt02Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printDataUpdateRpt02" method="post" onsubmit="return validateDataUpdateRpt02Form(this);">
    
        <fieldset>
            <legend>&nbsp;紓困貸款撥款情形查詢清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" id="btnPrint" name="btnPrint" tabindex="5" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.DataUpdateRpt02Form.onsubmit()){document.DataUpdateRpt02Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
