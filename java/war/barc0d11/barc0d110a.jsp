...
<%@ page import="tw.gov.bli.ba.decision.forms.DisabledPaymentDecisionForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BARC0D110A" />
    ...
    <html:javascript formName="DisabledPaymentDecisionForm" page="1" />           
    ...
    function initAll(){        
        ...
        <%if(request.getSession().getAttribute(ConstantKey.DISABLED_PAYMENT_DECISION_FORM) != null){%>
            var qryCond = '<c:out value ="<%=((DisabledPaymentDecisionForm)request.getSession().getAttribute(ConstantKey.DISABLED_PAYMENT_DECISION_FORM)).getQryCond()%>" />';
            if(qryCond=="2"){
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/disabledPaymentDecision" method="post" onsubmit="return validateDisabledPaymentDecisionForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" tabindex="70" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(checkFields()&&document.DisabledPaymentDecisionForm.onsubmit()){document.DisabledPaymentDecisionForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
