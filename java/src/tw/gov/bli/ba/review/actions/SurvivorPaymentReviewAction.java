    ...
    public ActionForward doQuery(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) {
        ...
        try {
            ...
            if (dataList.size() <= 0) {
                ...
                for (SurvivorPaymentReviewExtCase survivorPaymentReviewExtCase : beneficiaryDataList.get(0).getBenIssueDataList()) {
                    issueAmtTotal = issueAmtTotal.add(survivorPaymentReviewExtCase.getIssueAmt());
                }
