...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D110L" />
    ...
    <html:javascript formName="DataUpdateRpt01Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printDataUpdateRpt01" method="post" onsubmit="return validateDataUpdateRpt01Form(this);">
        
        <fieldset>
            <legend>&nbsp;紓困繳納查詢單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" id="btnPrint" name="btnPrint" tabindex="5" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.DataUpdateRpt01Form.onsubmit()){document.DataUpdateRpt01Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
