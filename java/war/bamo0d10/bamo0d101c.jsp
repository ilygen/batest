...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D101C" />
                    ...
                    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                        <tr>
                            <td align="right" colspan="8">
                                <acl:checkButton buttonName="btnSave">
                                    <input name="btnSave" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doConfirmRemittanceReceive'; if(checkFields()){document.OldAgePaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                            </acl:checkButton>
                                &nbsp;
                        ...
                        <tr>
                            ...
                            <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.ACCOUNTS_RECEIVABLE_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                <display:column title="序 號" headerClass="issuetitle_L" class="issueinfo_C" style="width:10%; text-align:center;">
                                                    <c:out value="${listItem_rowNum}" />&nbsp;
                                                </display:column>                   
