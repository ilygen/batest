 ...
 * @author Rickychi
 */
public class PaymentDecisionCase implements Serializable {
    ...
    private List<PaymentDecisionExtCase> benIssueDataList;// 受款人核定資料
    private List<PaymentDecisionExtCase> benChkDataList;// 受款人的編審註記
    private List<PaymentDecisionExtCase> otherChkDataList;// 受款人編審註記
    ...
    public List<PaymentDecisionExtCase> getBenIssueDataList() {
        return benIssueDataList;
    }

    public void setBenIssueDataList(List<PaymentDecisionExtCase> benIssueDataList) {
        this.benIssueDataList = benIssueDataList;
    }

    public List<PaymentDecisionExtCase> getBenChkDataList() {
        return benChkDataList;
    }

    public void setBenChkDataList(List<PaymentDecisionExtCase> benChkDataList) {
    ...
    public List<PaymentDecisionExtCase> getOtherChkDataList() {
        return otherChkDataList;
    }

    public void setOtherChkDataList(List<PaymentDecisionExtCase> otherChkDataList) {
