...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X122A" />
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            <legend>&nbsp;老年年金所得替代率參數維護作業新增&nbsp;</legend>
	            ...
	            <tr>
                    <td colspan="6" align="right">
                        ...
                        <acl:checkButton buttonName="btnSave">
			                <input name="btnSave" type="button" class="button" value="確  認 " onclick="$('page').value='1'; $('method').value='doSave'; if (document.ReplacementRatioMaintDetailForm.onsubmit() && checkRequireFields()){document.ReplacementRatioMaintDetailForm.submit();}else{return false;}" />
                        </acl:checkButton>
