...
/**
 * Case for 遺屬年金案件資料更正 - 編審註記資料
 * 
 * @author Goston
 */
public class SurvivorApplicationDataUpdateCheckFileCase implements Serializable {
    // BACHKFILE
    ...
    public SurvivorApplicationDataUpdateCheckFileCase() {
