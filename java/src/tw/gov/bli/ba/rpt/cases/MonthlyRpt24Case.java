 ...
 * @author Kiyomi
 */
public class MonthlyRpt24Case implements Serializable {
    ...
    public String getBankString() {
        return StringUtils.defaultString(payBankId) + StringUtils.defaultString(branchId);
    }
