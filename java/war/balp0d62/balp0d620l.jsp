...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D620L" />
    ...
    <html:javascript formName="MonthlyRpt26Form" page="1" />                   
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt26" method="post" onsubmit="return validateMonthlyRpt26Form(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;退匯/現應收已收清冊&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if(document.MonthlyRpt26Form.onsubmit() && checkFields()){document.MonthlyRpt26Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
	                    &nbsp;
