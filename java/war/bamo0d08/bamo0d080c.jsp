...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D080C" />
    ...
    <html:javascript formName="PayeeDataUpdateQueryForm" page="1" />
    ...
    function chkProcStat(procStat){
        if(procStat==''){
            ...
            document.PayeeDataUpdateQueryForm.submit();
        }else if(procStat=='2'){
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.PayeeDataUpdateQueryForm.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/payeeDataUpdateQuery" method="post" onsubmit="return validatePayeeDataUpdateQueryForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
			            ...
			            <acl:checkButton buttonName="btnQuery">
                            <input name="btnQuery" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.PayeeDataUpdateQueryForm.onsubmit()){getProcStat();}"/>&nbsp;
                        </acl:checkButton>
