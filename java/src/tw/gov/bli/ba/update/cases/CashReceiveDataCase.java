 ...
 * @author Noctis
 */
public class CashReceiveDataCase implements Serializable {
    ...
    public String getInsKdStr() {
        if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("1")) {
            return "勞保";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("2")) {
            return "農保";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("6")) {
            return "敬老一般";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("7")) {
            return "職業災害保護";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("8")) {
            return "老農";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("A")) {
            return "敬老原住民";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("B")) {
            return "就業保險";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("C")) {
            return "勞退";
        }
        else if (StringUtils.isNotBlank(getInsKd()) && getInsKd().equals("Y")) {
            return "SARS";
        }
        else {
            return "";
