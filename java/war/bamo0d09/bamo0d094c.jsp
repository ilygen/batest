...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D094C" />
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            <legend>&nbsp;老年年金受款人死亡改匯處理繼承人修改&nbsp;</legend>
                ...
                <tr>
                    <td align="right">
                        ...
                        <acl:checkButton buttonName="btnSave">
                            <input name="btnSave" type="button" class="button" value="確　認" onclick="checkIdnoExist();$('page').value='1'; $('method').value='doConfirm'; if (document.PayeeDataUpdateDetailForm.onsubmit() && checkRequireFields()){
                                                                                                ...
                                                                                                }else{document.PayeeDataUpdateDetailForm.submit();}}else{return false;}" />&nbsp;
                        </acl:checkButton>
