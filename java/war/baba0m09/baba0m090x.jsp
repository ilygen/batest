...
<%@ page import="tw.gov.bli.ba.bj.forms.MonthCheckKForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M090X" />
    ...
    <html:javascript formName="MonthCheckKForm" page="1" />      
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/monthCheckK" method="post" onsubmit="return validateMonthCheckKForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" tabindex="500" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(checkFields()&&document.MonthCheckKForm.onsubmit()){document.MonthCheckKForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnQueryList">
                            <input type="button" tabindex="510" name="btnQueryList" class="button" value="查  詢" onclick="$('page').value='1'; $('method').value='doQueryList'; if (document.MonthCheckKForm.onsubmit()){document.MonthCheckKForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
