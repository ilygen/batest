...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D340L" />
    ...
    <html:javascript formName="MonthlyRpt04Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt04Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt04" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt04Form(this);}">
        
        <fieldset>
            <legend>&nbsp;月核定撥付總表&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt04Form.onsubmit()){document.MonthlyRpt04Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
