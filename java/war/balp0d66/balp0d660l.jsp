...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D660L" />
    ...
    <html:javascript formName="OtherRpt07Form" page="1" />                   
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printOtherRpt07" method="post" onsubmit="return validateOtherRpt07Form(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;轉催收核定清冊&nbsp;</legend>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="3" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if(document.OtherRpt07Form.onsubmit() && checkFields()){document.OtherRpt07Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
	                   <acl:checkButton buttonName="btnCompQuery">
                            <input type="button" name="btnCompQuery" class="button" value="補　印" onclick="$('page').value='1'; $('method').value='doCompReport'; if(document.OtherRpt07Form.onsubmit() && checkFieldsComp()){document.OtherRpt07Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td>
                        <html:text property="demDate" styleId="demDate" styleClass="textinput" size="10" maxlength="7"  />
