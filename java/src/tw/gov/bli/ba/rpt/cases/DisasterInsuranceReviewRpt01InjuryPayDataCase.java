...
/**
 * Case for 災保傷病給付受理編審清單 - 請領他類給付資料 - 申請災保傷病給付記錄
 * 
 * @author Evelyn Hsu
 */

public class DisasterInsuranceReviewRpt01InjuryPayDataCase  implements Serializable{
    ...
    private String bmInjPfmDte; //給付起日
    private String bmInjPtoDte; //給付迄日
