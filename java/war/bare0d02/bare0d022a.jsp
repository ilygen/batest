...
<bean:define id="caseData" name="<%=ConstantKey.REVIEW_FEE_REVIEW_CASE%>" />
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BARE0D022A" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/reviewFeeReview" method="post">
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td align="right">
                        ...
                        <input type='hidden' id='reApNo' name='reApNo' value='<c:out value="${caseData.detailData.reApNo}"/>' />
                        <input type='hidden' id='apSeq' name='apSeq' value='<c:out value="${caseData.detailData.apSeq}"/>' />
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" id="btnConfirm" name="btnConfirm" tabindex="100" class="button" value="確　認" onclick="$('page').value='3'; $('method').value='doSave'; document.ReviewFeeReviewForm.submit();" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnBack">
                            <input type="button" id="btnBack" name="btnBack" tabindex="102" class="button" value="返　回" onclick="$('page').value='3'; $('method').value='doBackToListPage'; if (confirm('確定離開？')) { document.ReviewFeeReviewForm.submit(); } else {return false;}" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                            ...
                            <tr>
                                ...
                                <td id="iss" colspan="2">
                                    ...
                                    <c:if test="${not (empty caseData.detailData.bankName)}">
                                        (<c:out value="${caseData.detailData.bankName}" />)
                                    </c:if>
                                </td>
                            </tr>
                            <tr>
