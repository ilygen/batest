...
<%@ page import="tw.gov.bli.ba.decision.forms.SurvivorPaymentDecisionForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BARC0D210A" />
    ...
    <html:javascript formName="SurvivorPaymentDecisionForm" page="1" />           
    ...
    function initAll(){        
        ...
        <%if(request.getSession().getAttribute(ConstantKey.SURVIVOR_PAYMENT_DECISION_FORM) != null){%>
            var qryCond = '<c:out value ="<%=((SurvivorPaymentDecisionForm)request.getSession().getAttribute(ConstantKey.SURVIVOR_PAYMENT_DECISION_FORM)).getQryCond()%>" />';
            if(qryCond=="2"){
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/survivorPaymentDecision" method="post" onsubmit="return validateSurvivorPaymentDecisionForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" tabindex="70" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(checkFields()&&document.SurvivorPaymentDecisionForm.onsubmit()){document.SurvivorPaymentDecisionForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
