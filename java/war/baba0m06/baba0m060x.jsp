...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M060X" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/monthBatchK" method="post" onsubmit="return validateMonthBatchKForm(this);">
        ...
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確  認" onclick="$('page').value='1'; $('method').value='doConfirm'; if (document.MonthBatchKForm.onsubmit()){document.MonthBatchKForm.submit();}else{return false;}" tabindex="6"/>
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button_90" value="進度查詢" onclick="$('page').value='1'; $('method').value='doQuery'; document.MonthBatchKForm.submit();" tabindex="7"/>
                        </acl:checkButton>
                        &nbsp;
                ...
                <tr>
                    <td width="30%" align="right">
                        <span class="needtxt">＊</span>
                        <span class="issuetitle_R_down">給付種類：</span>
                    </td>
                    <td class="formtxt">
                         <html:radio styleId="paySeqNo1" property="paySeqNo" value="1" onblur="this.value=asc(this.value);"/>失能年金(35、38案)                                 
                         <html:radio styleId="paySeqNo2" property="paySeqNo" value="2" onblur="this.value=asc(this.value);"/>失能年金(36案) 
                    </td>
                </tr>
                <tr>
                    <td width="30%" align="right">
