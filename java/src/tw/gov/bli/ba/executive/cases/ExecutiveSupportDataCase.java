 ...
 * @author swim
 */
public class ExecutiveSupportDataCase implements Serializable {
    ...
    public String getSlrelateStr() {
        if (StringUtils.length(slrelate) == 13)
            return slrelate.substring(0, 3) + "-" + slrelate.substring(3, 5) + "-" + slrelate.substring(5, 6) + "-" + slrelate.substring(6, 12) + "-" + slrelate.substring(12, 13);
        else
            return StringUtils.defaultString(slrelate);
    }
    public String getSlrpNoStr() {
        if (StringUtils.length(slrpNo) == 13)
            return slrpNo.substring(0, 3) + "-" + slrpNo.substring(3, 5) + "-" + slrpNo.substring(5, 6) + "-" + slrpNo.substring(6, 12) + "-" + slrpNo.substring(12, 13);
        else
            return StringUtils.defaultString(slrpNo);
    }
    public String getCloseNoStr() {
        if (StringUtils.length(closeNo) == 13)
            return closeNo.substring(0, 3) + "-" + closeNo.substring(3, 5) + "-" + closeNo.substring(5, 6) + "-" + closeNo.substring(6, 12) + "-" + closeNo.substring(12, 13);
        else
            return StringUtils.defaultString(closeNo);
    }
    ...
    public String getSourceStr() {
        if(source.equals("") || source.equals(null)){
            ...
            if(source.equals(ConstantKey.MAADMREC_SOURCE_0) )
                return ConstantKey.MAADMREC_SOURCE_STR_0;
            else if(source.equals(ConstantKey.MAADMREC_SOURCE_1))
                return ConstantKey.MAADMREC_SOURCE_STR_1;
            else 
                return "";          
        }
    }
