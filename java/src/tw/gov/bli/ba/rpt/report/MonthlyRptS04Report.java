 ...
 * @author Kiyomi
 */
public class MonthlyRptS04Report extends ReportBase {

    private RptService rptService;

    public MonthlyRptS04Report() throws Exception {
        super();
    }
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt04Case> caseData, List<MonthlyRpt04Case> caseData1, List<MonthlyRpt04Case> caseDataFooter, List<MonthlyRpt04Case> caseDataFooter1, String paySeqNo,
        ...
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptS04_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
