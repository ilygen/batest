     ...
     <div align="center">
        <p align="center">
            <font size="5" style="letter-spacing: 8px">
                <strong>繳款單明細查詢作業(各期本金分配明細)</strong>
            </font>
        </p>
        ...
        <table border="0" align="center" cellpadding="2" cellspacing="2">
               ...
               <tr>
                ...
                <tr align="center">
                    <td width="181"><strong>期數</strong></font></td>
                    <td width="181"><strong>繳款單號</strong></font></td>
                    <td width="181"><strong>受理編號</strong></font></td>
                    <td width="181"><strong>核定年月</strong></font></td>
                    <td width="181"><strong>給付年月</strong></font></td>
                    <td width="185"><strong>應繳本金</strong></font></td>
                </tr>
                <tr>
                    <td><hr size="1" noshade></td>
                    <td><hr size="1" noshade></td>
                ...
                <logic:iterate id="listItemj" indexId="j"  name="<%=ConstantKey.PAYMENT_ASSIGN_LAST_CASE_LIST%>">
                <tr> 
                    <td align="center"><c:out value="${listItemj.nowStagForShow}" /></td>
                    <td align="center"><c:out value="${listItemj.paymentNoDetail}" /></td>
                    <td align="center"><c:out value="${listItemj.apno}" /></td>
                    <td align="center"><c:out  value="${listItemj.issuYm}" /></td>
                    <td align="center"><c:out  value="${listItemj.payYm}" /></td>
                    <td align="right"><fmt:formatNumber value="${listItem.payAmt}" /></td>
                </tr>
                </logic:iterate>
               <tr>
