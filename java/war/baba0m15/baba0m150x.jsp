...
<%@ page import="tw.gov.bli.ba.bj.forms.DisabledMediaBatchForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M150X" />
    ...
    <html:javascript formName="DisabledMediaBatchForm" page="1" />           
    ...
    function initAll(){        
       ...
       <%}else{%>
       		disabledMk =  '<c:out value="<%=((DisabledMediaBatchForm)request.getSession().getAttribute(ConstantKey.DISABLED_MEDIA_BATCH_FORM)).getDisabledMk()%>" />';
	    	if(disabledMk == "2"){
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/prodDisabledMediaBatch" method="post" onsubmit="return validateDisabledMediaBatchForm(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        <input type="hidden" id="checkResult" name="checkResult" value="">
        <fieldset>
            <legend>&nbsp;失能年金批次產製媒體檔作業&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnProMedia">
                            <input type="button" name="btnProMedia" class="button_120" value="產製媒體檔" onclick="$('page').value='1'; $('method').value='doProduct'; if(document.DisabledMediaBatchForm.onsubmit()){document.DisabledMediaBatchForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnDownMedia">
                            <input type="button" name="btnDownMedia" class="button_120" value="媒體檔下載" onclick="$('page').value='1'; $('method').value='doDownloadFile'; if(document.DisabledMediaBatchForm.onsubmit()){document.DisabledMediaBatchForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>    
                         <acl:checkButton buttonName="btnProcQuery">
                            <input type="button" name="btnProcQuery" class="button_120" value="進度查詢" onclick="$('page').value='1'; $('method').value='doQueryProcess'; if(document.DisabledMediaBatchForm.onsubmit()){document.DisabledMediaBatchForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>                                       
