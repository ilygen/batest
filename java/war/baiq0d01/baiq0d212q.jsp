...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D212Q" />
        ...
        if(issuDataList.length==0){
            ...
            for(var i=0; i<issuDataList.length; i++){
                ...
                for(var j=0; j<issuPayDataArray.length; j++){
                    ...
                    innerHTMLStr += '<table width="100%" border="0" cellpadding="0" cellspacing="2" class="px13" height="30">';
                    innerHTMLStr += '<tr>';
                    ...
                    if((j==0 && qryCond == "ISSUYM") || qryCond == "PAYYM"){
                        if(subIssuData.viewFlag == 'Y'){
                            innerHTMLStr += '<td width="12%" class="issuetitle_R_down">'
                            innerHTMLStr += '<acl:checkButton buttonName="btnDetail2"><input type="button" name="btnDetail2" class="button" value="檢　視" onclick="$(\'page\').value=\'1\'; $(\'method\').value=\'doReport\'; $(\'apNo\').value=\''+getDefaultString(subIssuData.apNo)+'\'; $(\'issuYm\').value=\''+getDefaultString(subIssuData.issuYm)+'\'; $(\'payYm\').value=\''+getDefaultString(subIssuData.payYm)+'\';document.PaymentQueryForm.submit();" /></acl:checkButton>';
                            innerHTMLStr += '</td>';
                        }else{
...
<body scroll="no">
    ...
    <div id="mainContent">
        ...
        <div id="main" class="mainBody">
            <html:form action="/paymentQuery" method="post">
                    ...
                    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                        ...
                        <tr>                
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td id="iss" colspan="2">
                                            <span class="issuetitle_L_down">老年年金受理編號：</span>
                                            <c:out value="${detail.oldApNo}" />&nbsp;
                                        </td>
                                        <td id="iss" width="25%">
                                            <span class="issuetitle_L_down">老年年金核定金額：</span>
                                            <fmt:formatNumber value="${detail.dabAnnuAmt}" />&nbsp;
                                        </td>
                                        <td id="iss">
                                            <span class="issuetitle_L_down">符合第63條之1第3項： </span>
                                            <c:out value="${disabledData.famAppMkStr}" />&nbsp;
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="iss" colspan="2">
                                            <span class="issuetitle_L_down">失能年金受理編號：</span>
                                            <c:out value="${detail.disApNo}" />&nbsp;
                                        </td>
                                        <td id="iss">
                                            <span class="issuetitle_L_down">失能年金核定金額：</span>
                                            <c:out value="${detail.disAnnuAmt}" />&nbsp;
                                        </td>
                                        <td id="iss">
                                    ...
                                    <tr>
                                        <td id="iss" colspan="2">
                                            ...
                                            <c:if test='${(detail.payYmsStr ne "")or(detail.payYmeStr ne "")or(detail.payAmts ne null)}'>
                                                &nbsp;／&nbsp;
                                            </c:if>
                                    ...
                                    <tr>
                                        ...
                                        <td id="iss" colspan="3">
                                            ...
                                            (鍵入/更正人員代號：<c:out value="${detail.crtUser}" />&nbsp;/&nbsp;<c:out value="${detail.updUser}" />)
                                        </td>
                                    </tr>
                                </table>
                            </td>
                                ...
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                        ...
                                        <td colspan="4">
                                            <table width="100%" cellpadding="0" cellspacing="0" class="px13">
                                                ...
                                                <td width="12%" valign="bottom" class="issuetitle_L" id="tabsJ">
                                                    <a href='<c:url value="/paymentQuery.do?method=doReviewRpt&action=single" />' target="_self">
                                                        <span>受理審核清單</span>
                                                    </a>
                                                </td>
                                            </table>
                                    ...
                                    <tr>
                                        ...
                                        <td id="iss" colspan="2">
                                            ...
                                            <fmt:formatNumber value="${detail.aplPayAmt + detail.inheritorAmt}" />&nbsp;
                                        </td>
                                    </tr><tr>
                                        <td id="iss" colspan="2">
                                            <span class="issuetitle_L_down">投保薪資：</span>
                                            <fmt:formatNumber value="${detail.lsInsmAmt}" />&nbsp;
                                        </td>                   
                                        <td id="iss" colspan="2">
                                    ...
                                    <tr>
                                        <td id="iss" colspan="2">
                                            ...
                                            <fmt:formatNumber value="${detail.oldaAmt}" />&nbsp;／&nbsp;<c:out value="${detail.oldAb}" />
                                        </td>
                                        <td id="iss" colspan="2">
                                            ...
                                            <c:if test="${(detail.oldRateDateYMStr ne '')or(detail.oldExtraRate ne null)}">
                                                &nbsp;／&nbsp;
                                            </c:if>
                                            <fmt:formatNumber value="${detail.oldExtraRate}" />
                                            <c:if test="${detail.oldExtraRate ne null}">
                                                %
                                            </c:if>&nbsp;
                                        </td>
                                    </tr>
                        ...
                        <tr>
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="4" align="left" class="issuetitle_L">
                                            <span class="systemMsg">▲</span>&nbsp;結案資料
                                        </td>
                                    </tr>
                                    <tr>
                                        <td id="iss" width="25%">
                                    ...
                                    <tr>
									    <td colspan="4">
									       <table width="100%" cellpadding="0" cellspacing="0" class="px13">
									            ...
									            <td width="12%" valign="bottom" class="issuetitle_L" id="tabsJ">
									                <a href="<c:url value="/executiveSupportQueryQuery.do?method=doQuery&qryFromWhere=BAIQ0D212Q&apNo=${detail.apNo}&issuYm=${detail.issuYmStr}" />" target="_self">
									                	<span>行政支援查詢</span>
									                </a>
									            </td>
									        </table>
                                                                        ...
                                                                        <table width="100%" border="0" cellspacing="0" cellpadding="0" class="px13" height="30">
                                                                            <tr>
                                                                                ...
                                                                                <td width="12%" class="issuetitle_R_down">
                                                                                    <c:if test="${((qryForm.qryCond eq 'ISSUYM') and (subIssuIndex eq '0')) or (qryForm.qryCond eq 'PAYYM')}">
                                                                                        <c:if test="${subIssu.viewFlag eq 'Y'}">
                                                                                            <acl:checkButton buttonName="btnDetail2">
                                                                                                <input type="button" name="btnDetail2" class="button" value="檢　視" onclick="$('page').value='1'; $('method').value='doReport'; $('apNo').value='<c:out value="${issu.apNo}" />'; $('issuYm').value='<c:out value="${issu.issuYm}" />'; $('payYm').value='<c:out value="${issu.payYm}" />';document.PaymentQueryForm.submit();" />&nbsp;
                                                                                            </acl:checkButton>
                                                                                        </c:if>
                                                                                    </c:if>&nbsp;
                                                                                </td>
                                                                ...
                                                                <logic:notEmpty name="subIssu" property="issuPayExtDataList">
                                                                    <c:if test="${subIssuIndex eq '0'}">
                                                                        <tr align="center">
                                                                            ...
                                                                            <td width="7%" class="issuetitle_L">存儲/實付金額</td>
                                                                    ...
                                                                    <logic:iterate id="issuExt" indexId="issuExtIndex" name="subIssu" property="issuPayExtDataList">
                                                                        <tr>
                                                                            ...
                                                                            <td width="7%" class="issueinfo_R">
                                                                                <fmt:formatNumber value="${issuExt.aplpayAmt + issuExt.inheritorAmt}" />&nbsp;
                                                                            </td>
