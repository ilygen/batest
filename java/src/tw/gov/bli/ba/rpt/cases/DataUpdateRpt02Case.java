...
/**
 * Case for 紓困貸款撥款情形查詢清單
 * 
 * @author Goston
 */
public class DataUpdateRpt02Case implements Serializable {
     ...
     * @return
     */
    public String getDateExmString() {
        if (StringUtils.length(dateExm) == 8)
            return DateUtility.formatChineseDateString(dateExm, false);
        else
            return StringUtils.defaultString(dateExm);
    }

    public DataUpdateRpt02Case() {
