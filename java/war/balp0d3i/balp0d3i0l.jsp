...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3I0L" />
    ...
    <html:javascript formName="MonthlyRpt18Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt18" method="post" onsubmit="return validateMonthlyRpt18Form(this);">

        <fieldset>
            <legend>&nbsp;退回現金轉暫收及待結轉清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="5" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt18Form.onsubmit()){document.MonthlyRpt18Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
