...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D390L" />
    ...
    <html:javascript formName="MonthlyRpt09Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt09" method="post" onsubmit="return validateMonthlyRpt09Form(this);">

        <fieldset>
            <legend>&nbsp;給付抵銷紓困貸款明細&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="4" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt09Form.onsubmit()){document.MonthlyRpt09Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnReset">
                            <input type="reset" name="btnReset" id="btnReset" tabindex="5" class="button" value="清  除" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
