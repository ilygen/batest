...
/**
 * Case for 勞保遺屬年金給付受理編審清單 - 請領他類給付資料 - 申請失能給付記錄
 * 
 * @author Evelyn Hsu
 */

public class SurvivorReviewRpt01DisablePayDataCase  implements Serializable {
    ...
    private String evtJobDate;//診斷日期
