...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X123C" />
    ...
    <html:javascript formName="ReplacementRatioMaintDetailForm" page="1" />
    ...
    function checkRequireFields() {
        ...
        if(!Trim($("insAvg4").value) == ""){
         ...
         if(!Trim($("insAvg1").value) == ""){
            if(Trim($("irrTypeA1").value) == "" || Trim($("irrTypeA2").value) == ""){
              msg += '「所得替代率第一式A1」「所得替代率第二式A2」為必輸欄位。\r\n'; 
            }
         }    	
         if(!Trim($("insAvg2").value) == ""){
            if(Trim($("irrTypeB1").value) == "" || Trim($("irrTypeB2").value) == ""){
              msg += '「所得替代率第一式B1」「所得替代率第二式B2」為必輸欄位。\r\n'; 
            }
         }    
         if(!Trim($("insAvg3").value) == ""){
            if(Trim($("irrTypeC1").value) == "" || Trim($("irrTypeC2").value) == ""){
              msg += '「所得替代率第一式C1」「所得替代率第二式C2」為必輸欄位。\r\n'; 
            }
         }    
         if(!Trim($("insAvg4").value) == ""){
            if(Trim($("irrTypeD1").value) == "" || Trim($("irrTypeD2").value) == ""){
              msg += '「所得替代率第一式D1」「所得替代率第二式D2」為必輸欄位。\r\n'; 
            }
         }    
         ...
         //「所得替代率第一式A1」的值大於「所得替代率第一式B1」的值大於「所得替代率第一式C1」的值大於「所得替代率第一式D1」的值。
         if(!Trim($("irrTypeB1").value) == ""){
             if(parseFloat(Trim($("irrTypeB1").value)) > parseFloat(Trim($("irrTypeA1").value))){
               msg += '「所得替代率第一式A1」的值須大於「所得替代率第一式B1」的值。\r\n'; 
             }
         } 
         if(!Trim($("irrTypeC1").value) == ""){
             if(parseFloat(Trim($("irrTypeC1").value)) > parseFloat(Trim($("irrTypeB1").value))){
               msg += '「所得替代率第一式B1」的值須大於「所得替代率第一式C1」的值。\r\n'; 
             }
         }
         if(!Trim($("irrTypeD1").value) == ""){
             if(parseFloat(Trim($("irrTypeD1").value)) > parseFloat(Trim($("irrTypeC1").value))){
               msg += '「所得替代率第一式C1」的值須大於「所得替代率第一式D1」的值。\r\n'; 
             }
         }
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/replacementRatioMaintDetail" method="post" onsubmit="return validateReplacementRatioMaintDetailForm(this);">
        
        <fieldset>
            <legend>&nbsp;老年年金所得替代率參數維護作業修改&nbsp;</legend>
            
            <div align="right" id="showtime">
                                網頁下載時間：民國&nbsp;<func:nowDateTime />
            </div>
            <bean:define id="replacementRatioData" name="<%=ConstantKey.REPLACEMENT_RATIO_MAINT_QUERY_CASE %>" />
	            ...
	            <tr>
                    <td colspan="6" align="right">
                        ...
                        <c:if test='${replacementRatioData.deleteUpdateStr ne "Y"}'>
                            <input name="btnSave" type="button" class="button" value="確  認 " onclick="$('page').value='1'; $('method').value='doConfirm'; if (document.ReplacementRatioMaintDetailForm.onsubmit() && checkRequireFields()){document.ReplacementRatioMaintDetailForm.submit();}else{return false;}" />
                        </c:if>
                        </acl:checkButton>
                        ...
                        <table width="98%" border="0" cellpadding="3" cellspacing="5" class="px13">
                            <tr>
                                <td width="20%">
                                    ...
                                    <c:out value="${ReplacementRatioMaintDetailForm.user}" />
                                </td>
                                <td width="40%">
                                    <span class="issuetitle_L_down">修改日期：</span>
                                    <c:out value="${ReplacementRatioMaintDetailForm.date}" />
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <c:if test='${replacementRatioData.deleteUpdateStr eq "Y"}'>
                        <table width="98%" cellpadding="3" cellspacing="5" class="px13">	
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式A1：</span>
        	                        <html:text styleId="irrTypeA1" property="irrTypeA1" size="6" maxlength="6" styleClass="textinput" disabled="true" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式A2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式B1：</span>
        	                        <html:text styleId="irrTypeB1" property="irrTypeB1" size="6" maxlength="6" styleClass="textinput" disabled="true" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式B2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式C1：</span>
        	                        <html:text styleId="irrTypeC1" property="irrTypeC1" size="6" maxlength="6" styleClass="textinput" disabled="true" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式C2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式D1：</span>
        	                        <html:text styleId="irrTypeD1" property="irrTypeD1" size="6" maxlength="6" styleClass="textinput" disabled="true" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式D2：</span>
	                    ...
	                    <table width="98%" cellpadding="3" cellspacing="5" class="px13">	
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式A1：</span>
        	                        <html:text styleId="irrTypeA1" property="irrTypeA1" size="6" maxlength="6" styleClass="textinput" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式A2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式B1：</span>
        	                        <html:text styleId="irrTypeB1" property="irrTypeB1" size="6" maxlength="6" styleClass="textinput" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式B2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式C1：</span>
        	                        <html:text styleId="irrTypeC1" property="irrTypeC1" size="6" maxlength="6" styleClass="textinput" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式C2：</span>
                            ...
                            <tr>
	                            ...
	                            <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第一式D1：</span>
        	                        <html:text styleId="irrTypeD1" property="irrTypeD1" size="6" maxlength="6" styleClass="textinput" />&nbsp;%&nbsp;
                                </td>
                                <td idth="33%" id="iss">
	                                <span class="issuetitle_L_down">所得替代率第二式D2：</span>
