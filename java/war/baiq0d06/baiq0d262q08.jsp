...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D262Q08" />
                        ...
                        <tr>
                            ...
                            <td align="right" >
                                <acl:checkButton buttonName="btnPrint">
                                    <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReportSimplifySurvivorFileList'; document.PaymentQueryForm.submit();"/>&nbsp;
                                </acl:checkButton>
