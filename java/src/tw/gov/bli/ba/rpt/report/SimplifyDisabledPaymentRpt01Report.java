 ...
 * @author frank
 */
public class SimplifyDisabledPaymentRpt01Report extends ReportBase {
    ...
    public SimplifyDisabledPaymentRpt01Report() throws Exception {
        super();
        nPage = 0;
...
//                }
            ...
            addColumn(table, 30, 1, "結案原因："+caseData.getCloseCause(), fontCh12, 0, LEFT);//結案原因：
            addColumn(table, 30, 1, "請領一次失能給付差額受理編號：" , fontCh12, 0, LEFT);//結案原因：請領一次失能給付差額受理編號
