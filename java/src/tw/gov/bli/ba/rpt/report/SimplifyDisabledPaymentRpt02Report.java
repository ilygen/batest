 ...
 * @author KIYOMI
 */
public class SimplifyDisabledPaymentRpt02Report extends ReportBase {
    ...
    public SimplifyDisabledPaymentRpt02Report() throws Exception {
        super();
        nPage = 0;
    ...
    public Table addHeader(UserBean userData, PaymentQueryDetailDataCase caseData, boolean attached) throws Exception {
        ...
        addColumn(table, 60, 1, "給付查詢 - 歸檔記錄（外單位專用）", fontCh18, 0, CENTER);
