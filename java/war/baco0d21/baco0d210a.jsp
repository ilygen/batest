...
<%@ page import="tw.gov.bli.ba.review.forms.SurvivorPaymentReviewForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BACO0D210A" />
    ...
    <html:javascript formName="SurvivorPaymentReviewForm" page="1" />      
    ...
    <%-- 
        ...
        <%if(request.getSession().getAttribute(ConstantKey.SURVIVOR_PAYMENT_REVIEW_FORM) != null){%>
            var qryCond = '<%=((SurvivorPaymentReviewForm)request.getSession().getAttribute(ConstantKey.SURVIVOR_PAYMENT_REVIEW_FORM)).getQryCond()%>';
            if(qryCond=="2"){
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/survivorPaymentReview" method="post" onsubmit="return validateSurvivorPaymentReviewForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" tabindex="70" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(checkFields()&&document.SurvivorPaymentReviewForm.onsubmit()){document.SurvivorPaymentReviewForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
