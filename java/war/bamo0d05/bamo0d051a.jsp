...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D051A" />
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnSave">
                            <input type="button" name="btnSave" class="button" value="新  增" onclick="$('page').value='1'; $('method').value='doInsert'; if (document.InheritorRegisterForm.onsubmit()&&checkFields()){document.InheritorRegisterForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
            ...
            <td align="center" class="table1">
              <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                ...
                <tr>
                  ...
                  <html:radio styleId="benNationTyp" property="benNationTyp" value="2" onclick="$('benNationTyp').value='2';changeBenNationTyp();"/>外籍</span></td>
                  ...
                  <td width="33%" id="iss"><span class="issuetitle_L_down"><div id="nationalityContent"><span class="issuetitle_L_down">國　籍：
