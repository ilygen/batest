...
<html:html lang="true">
<head>
    <acl:setProgId progId="BARE0D021A" />
                ...
                <tr>
                    <td align="right" colspan="7">
                        ...
                        <acl:checkButton buttonName="btnBack">
                            <input type="button" id="btnBack" name="btnBack" tabindex="100" class="button" value="返　回" onclick="$('page').value='2'; $('method').value='doBackToQueryPage'; document.ReviewFeeReviewForm.submit();" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
                    ...
                    <td colspan="7" align="right" valign="bottom">
                        <display:table name="pageScope.caseData.detailList" id="listItem" pagesize="10" excludedParams="*">
                            ...
                            <display:column title="&nbsp;資料明細&nbsp;" style="width:16%; text-align:center;">
                                <input type="button" name="btnDetail" class="button" value="個案審核" onclick="$('page').value='2'; $('method').value='doQueryDetailData'; $('listApSeq').value='<c:out value="${listItem.apSeq}" />'; document.ReviewFeeReviewForm.submit();" />
                            </display:column>
                        </display:table>
                    </td>
                </tr>
