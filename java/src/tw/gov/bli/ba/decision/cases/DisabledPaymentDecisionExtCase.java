...
/**
 * Case for 失能年金給付決行作業 額外資料
 * 
 * @author Rickychi
 */
public class DisabledPaymentDecisionExtCase implements Serializable {
    ...
    private BigDecimal recAmt; // 應回金額
    ...
    // 受款人核定資料
    // [
    private String badaprId;// 給付核定檔資料列編號
    ...
    // private String bmApDte; // 受理日期
    // private String bmEvName; // 事故者姓名
    // private String bmEvtDte; // 核定金額
    // private BigDecimal bmChkAmt; // 核定日期
    // private String bmExmDte; // 核付日期
    // private String bmPayDte; // 補件日期
    // private String bmNrepDate; // 補件註記
    // private String bmNdocMk; // 不給付日期
    // private String bmNopDate; // 診斷失能日期
    ...
    public String getBadaprId() {
        return badaprId;
    }

    public void setBadaprId(String badaprId) {
