...
<bean:define id="caseData" name="<%=ConstantKey.MONTHLY_RPT_08_FILE_LIST%>" />
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"> 
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D381L" />
    ...
    <html:javascript formName="MonthlyRpt08Form" page="2" />
                    ...
                    <td colspan="3" align="right">
                        <display:table name="pageScope.caseData" id="listItem" pagesize="0" excludedParams="*">
                            ...
                            <display:column title="操&nbsp;作" style="width:16%; text-align:center;">
                                <input type="button" name="btnDownload" class="button" value="下　載" onclick="$('page').value='2'; $('method').value='downloadFile'; $('downloadFileName').value='<c:out value="${listItem}" />'; document.MonthlyRpt08Form.submit();" />
                            </display:column>
                        </display:table>
                    </td>
                </tr>
