...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D162Q05" />
            ...
            <html:form action="/paymentQuerySimplify" method="post" onsubmit="">
                ...
                <fieldset>
                    ...
                    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                        ...
                        <tr>
                            <td class="issuetitle_L_down"><span class="issuetitle_search">&#9658;</span>&nbsp;複檢費用明細：</td>
                        </tr>
                        <tr>
                                ...
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td id="iss">
                                            ...
                                            <c:if test="${reFees.tel1 ne ''}">
                                                <c:out value="*****" />
                                            </c:if>&nbsp;
                                        </td>
                                        <td id="iss">
                                            <span class="issuetitle_L_down">電　話2：</span>
                                            <c:if test="${reFees.tel2 ne ''}">
                                                <c:out value="*****" />
                                            </c:if>&nbsp;
                                        </td>
                                        <td id="iss" colspan="2">
                                            <span class="issuetitle_L_down">地　址：</span>
                                            <c:if test="${reFees.commTyp ne ''}">
                                                <c:out value="********************" />
                                            </c:if>&nbsp;
                                        </td>
                                    </tr>
