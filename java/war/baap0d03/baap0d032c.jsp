...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAAP0D032C" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/survivorAnnuityReceiptList" method="post">
              ...
              <tr>
                <td align="right" colspan="8">
                    <acl:checkButton buttonName="btnBack">
                        <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack'; document.SurvivorAnnuityReceiptForm.submit();"/>
                    </acl:checkButton>
                </td>
              </tr>
              <tr align="center">
                <td>
                    <bean:define id="list" name="<%=ConstantKey.SURVIVOR_ANNUITY_RECEIPT_LIST%>" />
                    <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">
                        ...
                        <display:column title="申請項目" style="width:17%; text-align:left;">
                        ...
                        <display:column title="資料明細" style="width:10%; text-align:center;">
                            <acl:checkButton buttonName="btnModify">
                                <input type="button" name="btnModify" class="button" value="修　改" onclick="$('page').value='1'; $('method').value='prepareModifyDetail'; $('baappbaseId').value='<c:out value="${listItem.baappbaseId}" />'; document.SurvivorAnnuityReceiptForm.submit();" />&nbsp;
                            </acl:checkButton>                            
                        </display:column>
                    </display:table>              
                </td>
