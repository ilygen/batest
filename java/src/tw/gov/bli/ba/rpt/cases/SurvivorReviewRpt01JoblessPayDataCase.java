...
/**
 * Case for 勞保遺屬年金給付受理編審清單 - 請領他類給付資料 - 申請失業給付記錄 <br>
 * 注意: 本 Case 中的日期皆為民國日期
 * 
 * @author Evelyn Hsu
 */

public class SurvivorReviewRpt01JoblessPayDataCase implements Serializable{
        ...
        public String getSymDteString() {
            if (StringUtils.length(symDte) == 8)
                return DateUtility.formatChineseDateString(symDte, false);
            else
        ...
        public String getTymDteString() {
            if (StringUtils.length(tymDte) == 8)
                return DateUtility.formatChineseDateString(tymDte, false);
            else
        ...
        public String getApDteString() {
            if (StringUtils.length(apDte) == 8)
                return DateUtility.formatChineseDateString(apDte, false);
            else
        ...
        public String getTdteString() {
            if (StringUtils.length(tdte) == 8)
                return DateUtility.formatChineseDateString(tdte, false);
            else
        ...
        public String getChkDteString() {
            if (StringUtils.length(chkDte) == 8)
                return DateUtility.formatChineseDateString(chkDte, false);
            else
        ...
        public String getPayDteString() {
            if (StringUtils.length(payDte) == 8)
                return DateUtility.formatChineseDateString(payDte, false);
            else
        ...
        public String getNpyDteString() {
            if (StringUtils.length(npyDte) == 8)
                return DateUtility.formatChineseDateString(npyDte, false);
            else
        ...
        public String getBmEvtDteString() {
            if (StringUtils.length(bmEvtDte) == 8)
                return DateUtility.formatChineseDateString(bmEvtDte, false);
            else
        ...
        public String getAprDteString() {
            if (StringUtils.length(aprDte) == 8)
                return DateUtility.formatChineseDateString(aprDte, false);
            else
        ...
        public String getSavDt1String() {
            if (StringUtils.length(savDt1) == 8)
                return DateUtility.formatChineseDateString(savDt1, false);
            else
                return StringUtils.defaultString(savDt1);
        }
    
    public SurvivorReviewRpt01JoblessPayDataCase(){
