...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D610L" />
    ...
    <html:javascript formName="MonthlyRpt25Form" page="1" />                   
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt25" method="post" onsubmit="return validateMonthlyRpt25Form(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;退匯/現應收已收核定清單&nbsp;</legend>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if(document.MonthlyRpt25Form.onsubmit() && checkFields()){document.MonthlyRpt25Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
	                    &nbsp;
                ...
                <tr>
                    <td width="30%" align="right">
                        <span class="needtxt">＊</span>
                        <span class="issuetitle_R_down">已收日期：</span>
                    </td>
                    <td>
