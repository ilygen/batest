...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M110X" />
    ...
    <html:javascript formName="MonthLForm" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/monthL" method="post" onsubmit="return validateMonthLForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確  認" onclick="$('page').value='1'; $('method').value='doQuery'; if (document.MonthLForm.onsubmit()){document.MonthLForm.submit();}else{return false;}" tabindex="6"/>
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="查  詢" onclick="$('page').value='1'; $('method').value='doQueryList'; if (document.MonthLForm.onsubmit()){document.MonthLForm.submit();}else{return false;}" tabindex="7"/>
                        </acl:checkButton>
                        &nbsp;
