...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D370L" />
    ...
    <html:javascript formName="MonthlyRpt07Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt07" method="post" onsubmit="return validateMonthlyRpt07Form(this);">

        <fieldset>
            <legend>&nbsp;月核定給付撥款總額表&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="3" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt07Form.onsubmit()){document.MonthlyRpt07Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnReset">
                            <input type="reset" name="btnReset" id="btnReset" tabindex="4" class="button" value="清  除" />
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
