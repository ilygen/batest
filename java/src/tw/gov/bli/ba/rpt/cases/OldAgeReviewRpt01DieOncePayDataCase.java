...
/**
 * Case for 勞保老年年金給付受理編審清單 - 事故者死亡一次給付相關資料
 * 
 * @author Goston
 */
public class OldAgeReviewRpt01DieOncePayDataCase implements Serializable {
    ...
    public OldAgeReviewRpt01DieOncePayDataCase() {
