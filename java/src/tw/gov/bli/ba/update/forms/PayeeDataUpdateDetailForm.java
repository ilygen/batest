...
public class PayeeDataUpdateDetailForm extends BaseValidatorForm {
    ...
    private String idnoExist;//檢核錯誤檔生日
    ...
    public String getOldPayBankIdBranchId() {
    	if(StringUtils.isBlank(oldPayBankId)){
    		payBankId = "";
    	}
    	if(StringUtils.isBlank(oldBranchId)){
    		branchId = "";
    	}
    	oldPayBankIdBranchId = oldPayBankId + oldBranchId;
