...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D630L" />
    ...
    <html:javascript formName="MonthlyRpt27Form" page="1" />                   
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt27" method="post" onsubmit="return validateMonthlyRpt27Form(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;退匯/現應收已收註銷核定清單&nbsp;</legend>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if(document.MonthlyRpt27Form.onsubmit() && checkFields()){document.MonthlyRpt27Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
	                    &nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <html:text property="seqNo" styleId="seqNo" styleClass="textinput" size="4" maxlength="4" onblur="this.value=asc(this.value)" onkeyup="autotab($('seqNo'), $('chkDate'))"/>
                    </td>
                </tr>   
                <tr>
                    <td width="30%" align="right">
                        <span class="needtxt">＊</span>
                        <span class="issuetitle_R_down">註銷日期：</span>
                    </td>
                    <td>
                        <html:text property="chkDate" styleId="chkDate" styleClass="textinput" size="7" maxlength="7" onblur="this.value=asc(this.value)" onkeyup="autotab($('chkDate'), $('receiveType'))"/>
                    </td>
                </tr>   
                <tr>    
                    <td width="30%" align="right">
                    ...
                    <td>
                        <html:select property="receiveType" styleId="receiveType" styleClass="formtxt">
                            ...
                            <html:option value="1">1-退匯</html:option>
                            <html:option value="2">2-退現</html:option>
                        </html:select> 
                    </td>                         
                </tr>
                <tr>
