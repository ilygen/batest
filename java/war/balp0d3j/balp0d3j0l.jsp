...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3J0L" />
    ...
    <html:javascript formName="MonthlyRpt19Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt19Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt19" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt19Form(this);}">
        
        <fieldset>
            <legend>&nbsp;應收已收核定清單&nbsp;</legend> 
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt19Form.onsubmit()){document.MonthlyRpt19Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
