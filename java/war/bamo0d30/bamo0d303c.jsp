...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D303C" />
                        ...
                        <tr>
                            <td align="right" colspan="8">
                                <acl:checkButton buttonName="btnSave">
                                    <input name="btnSave" type="button" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doCancelRemittanceReceive'; if(checkFields()){document.SurvivorPaymentReceiveForm.submit();}else{return false;}" />&nbsp;      
	                            </acl:checkButton>
                                &nbsp;
                        ...
                        <tr>
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="8" class="issuetitle_L"><span class="systemMsg">▲</span>&nbsp;退匯已收資料</td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="center">
                                            <bean:define id="list" name="<%=ConstantKey.SURVIVOR_REMITTANCE_RECEIVE_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                ...
                                                <display:column title="核定年月" headerClass="issuetitle_L" class="issueinfo_C" style="text-align:center;">
                                                    <c:out value="${listItem.oriIssuYm}" />&nbsp;
                                                </display:column>
                                                <display:column title="給付年月" headerClass="issuetitle_L" class="issueinfo_C" style="text-align:center;">
                                                    <c:out value="${listItem.payYm}" />&nbsp;
                                                </display:column>
                                                <display:column title="退匯日期" headerClass="issuetitle_L" class="issueinfo_C" style="text-align:center;">
                                                    <c:out value="${listItem.brChkDate}" />&nbsp;
                                                </display:column>
                                                <display:column title="退匯金額" headerClass="issuetitle_L" class="issueinfo_C" style="text-align:right;">
