...
<%@ page import="tw.gov.bli.ba.bj.forms.SurvivorMediaOnlineForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M190X" />
    ...
    <html:javascript formName="SurvivorMediaOnlineForm" page="1" />           
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/prodSurvivorMediaOnline" method="post" onsubmit="return validateSurvivorMediaOnlineForm(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        <input type="hidden" id="checkResult" name="checkResult" value="">
        <fieldset>
            <legend>&nbsp;遺屬年金線上產製媒體檔作業 &nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnProMedia">
                            <input type="button" name="btnProMedia" class="button_120" value="產製媒體檔" onclick="$('page').value='1'; $('method').value='doProduct'; if(document.SurvivorMediaOnlineForm.onsubmit()){document.SurvivorMediaOnlineForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnDownMedia">
                            <input type="button" name="btnDownMedia" class="button_120" value="媒體檔下載" onclick="$('page').value='1'; $('method').value='doDownloadFile'; if(document.SurvivorMediaOnlineForm.onsubmit()){document.SurvivorMediaOnlineForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>    
                         <acl:checkButton buttonName="btnProcQuery">
                            <input type="button" name="btnProcQuery" class="button_120" value="進度查詢" onclick="$('page').value='1'; $('method').value='doQueryProcess'; if(document.SurvivorMediaOnlineForm.onsubmit()){document.SurvivorMediaOnlineForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>                                       
