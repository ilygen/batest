...
<%@ page import="tw.gov.bli.ba.receipt.forms.DisabledAnnuityWalkInReceiptQueryForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"> 
<html:html lang="true">
<head>
    <acl:setProgId progId="BAAP0D040A" />
    ...
    <html:javascript formName="DisabledAnnuityWalkInReceiptQueryForm" page="1" />        
    ...
    function doSubmit() {
    	var procType = $('procType').value;
    	$('method').value = 'prepareInsertBa';
    	
    	if (procType == '1' || 
    			(checkFields(procType) && document.DisabledAnnuityWalkInReceiptQueryForm.onsubmit())) {
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/disabledAnnuityWalkInReceipt" method="post" onsubmit="return validateDisabledAnnuityWalkInReceiptQueryForm(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;失能年金臨櫃受理作業&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnInsert">
                            <input type="button" id="btnInsert" name="btnInsert" tabindex="40" class="button" value="新　增" onclick="doSubmit()"/>&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnClear">
                            <input type="button" id="btnClear" name="btnClear" tabindex="50" class="button" value="清　除" onclick="resetForm();"/>
                        </acl:checkButton>                        
                    </td>
                </tr> 
                <tr>
                    ...
                    <td>
                    	<html:select property="procType" tabindex="10" onchange="changeProcType();">
                    		<html:option value="1">1-普通失能年金受理</html:option>
                    		<html:option value="2">2-職災失能一次金(轉入)</html:option>
                    		<html:option value="3">3-普通失能一次金(轉入)</html:option>
                    		<html:option value="4">4-職災失能年金(轉入)</html:option>
                    	</html:select>
                    </td>
                </tr>   
                <tr id="apnoBc">
