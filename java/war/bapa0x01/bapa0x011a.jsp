...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAPA0X011A" />
	            ...
	            <tr>
                    <td colspan="6" align="right">
                        ...
                        <acl:checkButton buttonName="btnSave">
			                <input name="btnSave" type="button" class="button" value="確  認 " onclick="$('page').value='1'; $('method').value='doSave'; if (document.CheckMarkMaintDetailForm.onsubmit() && checkRequireFields()){document.CheckMarkMaintDetailForm.submit();}else{return false;}" />&nbsp;&nbsp;
                        </acl:checkButton>
