...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3M0L" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt22Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="5" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt22Form.onsubmit()){document.MonthlyRpt22Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnReset">
                            <input type="reset" name="btnReset" id="btnReset" tabindex="6" class="button" value="清  除" onclick="resetForm();"/>
                        </acl:checkButton>
                    </td>
                </tr>
                <tr>
