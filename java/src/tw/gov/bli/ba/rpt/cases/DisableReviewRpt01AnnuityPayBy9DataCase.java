...
/**
 * Case for 災保失能年金給付受理編審清單 - 請領同類給付資料 - 年金給付
 * 
 * @author Evelyn Hsu
 */

public class DisableReviewRpt01AnnuityPayBy9DataCase implements Serializable {
    ...
    private String evtJobDate; //失能診斷日
    ...
    public DisableReviewRpt01AnnuityPayBy9DataCase() {
