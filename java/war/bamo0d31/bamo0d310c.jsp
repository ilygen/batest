...
<html:html lang="true">
<head>
<acl:setProgId progId="BAMO0D310C" />
...
<%-- begin ... [ --%>
	function resetForm() {
		document.CloseStatusAlterationForm.reset();
		initAll();
	}
<%-- ] ... end --%>
...
<body scroll="no">
	...
	<div id="mainContent">
		...
		<div id="main" class="mainBody">
			<html:form action="/survivorCloseStatusAlteration" method="post" onsubmit="">
						...
						<tr>
							<td colspan="2" align="right">
								<acl:checkButton buttonName="btnQuery">
									<input type="button" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQueryList'; if(checkFields()){document.CloseStatusAlterationForm.submit();}else{return false;}" />&nbsp;
                        		</acl:checkButton> 
