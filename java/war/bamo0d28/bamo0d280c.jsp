...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D280C" />
    ...
    <html:javascript formName="SurvivorPayeeDataUpdateQueryForm" page="1" />
    ...
    function chkProcStat(procStat){
        if(procStat==''){
            ...
            document.SurvivorPayeeDataUpdateQueryForm.submit();
        }else if(procStat=='2'){
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.SurvivorPayeeDataUpdateQueryForm.reset();
        initAll();       
    }
    <%-- ] ... end --%>
    ...
    <body scroll="no">
    	<div id="content">
    		...
    		<%@ include file="/includes/ba_menu.jsp"%>
                ...
                <html:form action="/survivorPayeeDataUpdateQuery" method="post" onsubmit="return validateSurvivorPayeeDataUpdateQueryForm(this);">
                    <fieldset>
                            ...
                            <tr>
								<td colspan="2" align="right">
									...
									<acl:checkButton buttonName="btnQuery">
										<input name="btnQuery" type="button" class="button"	value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.SurvivorPayeeDataUpdateQueryForm.onsubmit()){getProcStat();}" />&nbsp;
                        			</acl:checkButton>
