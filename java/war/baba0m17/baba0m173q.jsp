...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M173Q" />
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="8" align="right">
                        <acl:checkButton buttonName="btnBack">
                          <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack';  document.OldMediaOnlineForm.submit();" />&nbsp;
                         </acl:checkButton>                                             
                    </td>
                </tr>                
                ...
                <tr align="center">                   
                    <td>
                        <bean:define id="list" name="<%=ConstantKey.OLD_MEDIA_ONLINE_PROGRESS_DTL_CASE_LIST%>" />
