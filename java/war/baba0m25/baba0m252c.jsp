...
<html:html lang="true">
<head>
<acl:setProgId progId="BABA0M252C" />
...
<body scroll="no">
	...
	<div id="mainContent">
		...
		<div id="main" class="mainBody">
			<html:form action="/disabledPayment" method="post" onsubmit="return validateCompPaymentForm(this);">
				<html:hidden styleId="page" property="page" value="1" />
				<html:hidden styleId="method" property="method" value="" />
				<fieldset>
					<legend>&nbsp;失能年金補正核付修改作業&nbsp;</legend>
						...
						<tr>
							<td align="right" colspan="7">
                                <acl:checkButton buttonName="btnConfirm">
                                    <input tabindex="260" type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='modifyPageDoConfirm'; if (document.CompPaymentForm.onsubmit()){document.CompPaymentForm.submit();}else{return false;}" />&nbsp;
                                </acl:checkButton>
                            ...
                            <td colspan="7">
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                                    <tr>
                                        ...
                                        <td><span class="issuetitle_L_down">給付別：</span>失能年金</td>
                                    </tr>
                                </table>
                            </td>
                        </tr>
