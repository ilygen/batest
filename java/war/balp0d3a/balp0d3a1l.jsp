...
<bean:define id="caseData" name="<%=ConstantKey.MONTHLY_RPT_10_FILE_LIST%>" />
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN"> 
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3A1L" />
    ...
    <html:javascript formName="MonthlyRpt10Form" page="3" />
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <html:hidden styleId="method" property="method" value="downloadFile" />
                    ...
                    <td colspan="3" align="right">
                        <display:table name="pageScope.caseData" id="listItem" pagesize="0" excludedParams="*">
                            ...
                            <display:column title="操&nbsp;作" style="width:16%; text-align:center;">
                                <input type="button" name="btnDownload" class="button" value="下　載" onclick="$('page').value='3'; $('method').value='downloadFile'; $('downloadFileName').value='<c:out value="${listItem}" />'; document.MonthlyRpt10Form.submit();" />
                            </display:column>
                        </display:table>
                    </td>
                </tr>
