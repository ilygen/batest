...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAMO0D160C" />
    ...
    <html:javascript formName="DisabledCheckMarkLevelAdjustForm" page="1" />
    ...
    function chkProcStat(procStat){
        if(procStat==''){
            ...
            document.DisabledCheckMarkLevelAdjustForm.submit();
        }else if(procStat=='2'){
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/disabledCheckMarkLevelAdjust" method="post" onsubmit="return validateDisabledCheckMarkLevelAdjustForm(this);">
