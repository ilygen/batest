...
/**
 * Case for 遺屬年金受款人資料更正
 * @author Azuritul
 *
 */
public class SurvivorPayeeDataUpdateCase implements Serializable{
	...
	public String getHasHeir() {
		return hasHeir;
	}

	public void setHasHeir(String hasHeir) {
		this.hasHeir = hasHeir;
	}
