...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3O0L" />
    ...
    <html:javascript formName="MonthlyRpt24Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt24" method="post" onsubmit="return validateMonthlyRpt24Form(this);">

        <fieldset>
            <legend>&nbsp;代扣補償金清冊&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" name="btnPrint" id="btnPrint" tabindex="6" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt24Form.onsubmit()){document.MonthlyRpt24Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                ...
                <tr>
                    ...
                    <td>
                        <html:select styleId="payCode" property="payCode" tabindex="1">
                            <html:option value="L">L-老年年金</html:option>
                        </html:select>
                    </td>
                </tr>
                <tr>
