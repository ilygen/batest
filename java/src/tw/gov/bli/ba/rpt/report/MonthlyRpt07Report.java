 ...
 * @author Goston
 */
public class MonthlyRpt07Report extends ReportBase {
    private String printDate = ""; // 印表日期

    public MonthlyRpt07Report() throws Exception {
        super();
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt07Case> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRpt07_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
