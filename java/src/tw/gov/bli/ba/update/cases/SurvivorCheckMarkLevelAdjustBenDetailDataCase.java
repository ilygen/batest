...
/**
 * Case for 遺屬年金編審註記程度調整 - 受款人編審註記資料
 * 
 * @author Goston
 */
public class SurvivorCheckMarkLevelAdjustBenDetailDataCase implements Serializable {
    ...
    public SurvivorCheckMarkLevelAdjustBenDetailDataCase() {
