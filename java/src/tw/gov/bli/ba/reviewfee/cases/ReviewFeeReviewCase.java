 ...
 * @author Goston
 */
public class ReviewFeeReviewCase implements Serializable {
    // Header
    // [
    // BABCML7
    ...
    private ReviewFeeReviewDetailCase detailData; // Detail 頁面之該筆明細資料

    // BABCML7 - 複檢費用主檔明細資料
    private List<ReviewFeeReviewDetailCase> detailList; // List 頁面之清單明細資料
     ...
     * @param detailData
     */
    public void addDetailData(ReviewFeeReviewDetailCase detailData) {
        if (detailList == null)
            detailList = new ArrayList<ReviewFeeReviewDetailCase>();
     ...
     * @return
     */
    public ReviewFeeReviewDetailCase getDetailDataByApSeq(BigDecimal apSeq) {
        if (apSeq == null)
            return null;

        for (ReviewFeeReviewDetailCase detailData : detailList) {
    ...
    public ReviewFeeReviewDetailCase getDetailData() {
        return detailData;
    }

    public void setDetailData(ReviewFeeReviewDetailCase detailData) {
        this.detailData = detailData;
    }

    public List<ReviewFeeReviewDetailCase> getDetailList() {
        return detailList;
    }

    public void setDetailList(List<ReviewFeeReviewDetailCase> detailList) {
