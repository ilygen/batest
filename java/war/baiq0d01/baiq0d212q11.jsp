...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D212Q11" />
                                ...
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td width=100% class="issuetitle_L">
                                            <span class="systemMsg">▲</span>&nbsp;重殘起迄年月
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width=100% align="center">
                                            <bean:define id="list" name="<%=ConstantKey.PAYMENT_QUERY_HANDICAP_DETAIL_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">                            
                                                ...
                                                <display:column title="重殘起迄年月" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:center;">
                                                    <c:out value="${listItem.handicapSdateStr}" />
                                                    <c:if test="${(listItem.handicapSdateStr ne '')or(listItem.handicapEdateStr ne '')}">
                                                        &nbsp;~&nbsp;
                                                    </c:if>
                                                    <c:out value="${listItem.handicapEdateStr}" />&nbsp;
                                                </display:column>
                                                <display:column title="　" headerClass="issuetitle_L" class="issueinfo_C" style="width:78%; text-align:center;">
                                                    &nbsp;
                                                </display:column>
                                            </display:table>
                                        </td>
