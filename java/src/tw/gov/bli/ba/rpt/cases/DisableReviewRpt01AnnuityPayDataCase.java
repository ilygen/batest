...
/**
 * Case for 勞保失能年金給付受理編審清單 - 請領同類給付資料 - 年金給付
 * 
 * @author Evelyn Hsu
 */

public class DisableReviewRpt01AnnuityPayDataCase implements Serializable {
    ...
    public DisableReviewRpt01AnnuityPayDataCase() {
