...
/**
 * 現金給付參考檔 (<code>PBBMSA</code>) <br>
 * 
 * @author Goston
 */
public class Bebmsa implements Serializable {
    ...
    // Field not in PBBMSA
    // [
    private String bmCriInjCl; // 殘廢等級
    private String bmCriInjDp; // 殘廢項目
    private String uname; // CAUB.unName - 申請代算單位名稱 for 受款人資料更正
