 ...
 * @author Goston
 */
public class OtherRpt01Case implements Serializable {
    // 給付主檔 - 事故者資料
    // [
    ...
    public String getArcDateString() {
        if (StringUtils.length(arcDate) == 8)
            return DateUtility.formatChineseDateString(DateUtility.changeDateType(arcDate), false);
        else
            return "";
    }

    public OtherRpt01Case() {
    }
