...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D162Q06" />
                        ...
                        <tr>
                            ...
                            <td align="right" >
                                <acl:checkButton buttonName="btnBack">
                                    <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doDisabledFamilyData'; document.PaymentQueryForm.submit();" />&nbsp;
                                </acl:checkButton>
                            </td>
                            </tr>
                            </table>
                                ...
                                <table width="100%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td width=100% class="issuetitle_L">
                                            <span class="systemMsg">▲</span>&nbsp;在學起迄年月
                                        </td>
                                    </tr>
                                    <tr>
                                        <td width=100% align="center">
                                            <bean:define id="list" name="<%=ConstantKey.PAYMENT_QUERY_DISABLED_STUD_DETAIL_DATA_CASE_LIST%>" />
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>">                            
                                                ...
                                                <display:column title="在學起迄年月" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:center;">
                                                    <c:out value="${listItem.studSdateStr}" />
                                                    <c:if test="${(listItem.studSdateStr ne '')or(listItem.studEdateStr ne '')}">
                                                        &nbsp;~&nbsp;
                                                    </c:if>
                                                    <c:out value="${listItem.studEdateStr}" />&nbsp;
                                                </display:column>
