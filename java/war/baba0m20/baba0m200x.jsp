...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M200X" />
    ...
    <html:javascript formName="CheckJobRptForm" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/checkJobRpt" method="post" onsubmit="return validateCheckJobRptForm(this);">
        
        <fieldset>
            <legend>&nbsp;產生檢核案件作業&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" id="btnPrint" name="btnPrint" tabindex="3" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReportExcel'; if (document.CheckJobRptForm.onsubmit()){document.CheckJobRptForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
