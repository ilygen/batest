 ...
 * @author Goston
 */
public class MonthlyRptS09Report extends ReportBase {
    private String printDate = ""; // 印表日期

    public MonthlyRptS09Report() throws Exception {
        super();
    ...
    public ByteArrayOutputStream doReport(UserBean userData, List<MonthlyRpt09Case> caseList, HashMap<String, Object> map) throws Exception {
        try {
            ...
            printToDisk((PropertyHelper.getProperty("rpt.path") + Encode.forJava(payCode) + "_MonthlyRptS09_" + Encode.forJava(printDate) + ".pdf"), bao);
        }
        finally {
            document.close();
        }
