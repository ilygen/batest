...
<%@ page import="tw.gov.bli.ba.query.cases.PaymentQueryIssuPayDataCase" %>
<%@ page import="tw.gov.bli.ba.query.cases.PaymentQueryIssuPayExtDataCase" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D112Q" />
                ...
                <fieldset>
                    ...
                    <table width="98%" border="0" align="center" cellpadding="2" cellspacing="0" class="px13">
                        <tr>
                            ...
                            <tr>
                            <td align="left" colspan="7" style="color: blue;font-size: 120%;font-weight: bold;">
                            ...
                            <td align="right" colspan="7">
                                <acl:checkButton buttonName="btnPrint">
                                    <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReportDisabledApplicationData'; document.PaymentQueryForm.submit();"/>&nbsp;
                                </acl:checkButton>
                        ...
                        <tr>
                            <td colspan="14">
                                ...
                                <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                                    <tr>
                                        <td width="33%">
                                            <span class="issuetitle_L_down">受理編號1：</span>
                        ...
                        <tr>
                            <td colspan="14" align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    ...
                                    <tr>
                                        <td id="iss" colspan="1">
                                            <span class="issuetitle_L_down">差額金受理編號：</span>
                                            <c:out value="${detail.bmApNo}" />&nbsp;
                                        </td>
                                        <td id="iss" colspan="1">
                                            <span class="issuetitle_L_down">差額金金額：</span>
                                            <fmt:formatNumber value="${detail.bmChkAmt}" />&nbsp;
                                        </td> 
                                        <td id="iss" colspan="2">
                                            <span class="issuetitle_L_down">差額金核付日期：</span>
                                            <c:out value="${detail.bmPayDteStr}" />&nbsp;
                                        </td>                                                                                                                     
                                    </tr>
                                </table>
                            </td>
                                    ...
                                    <tr>
                                        <td colspan="4">
                                           <table width="100%" cellpadding="0" cellspacing="0" class="px13">
                                                ...
                                                <td width="12%" valign="bottom" class="issuetitle_L" id="tabsJ">
                                                    <a href="<c:url value="/executiveSupportQueryQuery.do?method=doQuery&qryFromWhere=BAIQ0D112Q&apNo=${detail.apNo}&issuYm=${detail.issuYmStr}" />" target="_self">
                                                        <span>行政支援查詢</span>
                                                    </a>
                                                </td>
                                            </table>
