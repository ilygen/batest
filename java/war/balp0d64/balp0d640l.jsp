...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D640L" />
    ...
    <html:javascript formName="MonthlyRpt28Form" page="1" />                   
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt28" method="post" onsubmit="return validateMonthlyRpt28Form(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if(document.MonthlyRpt28Form.onsubmit() && checkFields()){document.MonthlyRpt28Form.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
	                    &nbsp;
