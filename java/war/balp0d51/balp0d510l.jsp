...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D510L" />
    ...
    <html:javascript formName="OtherRpt01Form" page="1" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printOtherRpt01" method="post" onsubmit="return validateOtherRpt01Form(this);">

        <fieldset>
            <legend>&nbsp;調卷&nbsp;/&nbsp;還卷單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input type="button" id="btnPrint" name="btnPrint" tabindex="5" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.OtherRpt01Form.onsubmit()){document.OtherRpt01Form.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
