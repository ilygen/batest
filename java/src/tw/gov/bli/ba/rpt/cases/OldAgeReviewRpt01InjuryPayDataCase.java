...
/**
 * Case for 勞保老年年金給付受理編審清單 - 請領他類給付資料 - 申請傷病給付記錄
 * 
 * @author Goston
 */
public class OldAgeReviewRpt01InjuryPayDataCase implements Serializable {
    ...
    public OldAgeReviewRpt01InjuryPayDataCase() {
    }
