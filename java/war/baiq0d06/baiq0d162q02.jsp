...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D162Q02" />
                                        ...
                                        <tr>
                                            <td id="iss" colspan="2">
                                                ...
                                                <c:if test="${(famData.studSdate ne '')or(famData.studEdate ne '')}">
                                                    <a href="<c:url value="/paymentQuerySimplify.do?method=doDisabledStudDetailData&apNo=${famData.apNo}&seqNo=${famData.seqNo}" />" title="連結至：在學起迄年月" target="_self">
