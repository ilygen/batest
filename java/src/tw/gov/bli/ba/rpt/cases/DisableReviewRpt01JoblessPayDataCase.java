...
/**
 * Case for 勞保失能年金給付受理編審清單 - 請領他類給付資料 - 申請失業給付記錄 <br>
 * 注意: 本 Case 中的日期皆為民國日期
 * 
 * @author Evelyn Hsu
 */

public class DisableReviewRpt01JoblessPayDataCase implements Serializable{
    ...
    public DisableReviewRpt01JoblessPayDataCase() {
