...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAAP0D023C" />
    ...
    <html:javascript formName="DisabledAnnuityReceiptForm" page="1" />
    ...
    //取得欲修改之眷屬資料
    function getFamDetailData(bafamilyId){
        receiptCommonAjaxDo.getDisabledFamDetailData(bafamilyId, setFamData);  
    }
    
    function setFamData(famCase){
        $("bafamilyId").value = famCase.bafamilyId;
        $("famSeqNo").value = famCase.seqNo;     
    ...
    function initCriInPart(){
        //受傷部位
        if('<c:out value="${DisabledAnnuityReceiptForm.criInPart2}" />'!=""){
            $("criInPart2").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInPart2").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInPart3}" />'!=""){
    ...
    function initCriInJdp(){
        //失能項目
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp2}" />'!=""){
            $("criInJdp2").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp2").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp3}" />'!=""){
            $("criInJdp3").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp3").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp4}" />'!=""){
            $("criInJdp4").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp4").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp5}" />'!=""){
            $("criInJdp5").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp5").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp6}" />'!=""){
            $("criInJdp6").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp6").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp7}" />'!=""){
            $("criInJdp7").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp7").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp8}" />'!=""){
            $("criInJdp8").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp8").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp9}" />'!=""){
            $("criInJdp9").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJdp9").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJdp10}" />'!=""){
    ...
    function initDoctorName(){
        //醫師姓名
        if('<c:out value="${DisabledAnnuityReceiptForm.doctorName2}" />'!=""){
    ...
    function initCriInJnme(){
        //國際疾病代碼
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJnme2}" />'!=""){
            $("criInJnme2").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJnme2").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJnme3}" />'!=""){
            $("criInJnme3").disabled = false;                                                                                                                                                                                                                                                                                                                  
        }else{
            $("criInJnme3").disabled = true;                                                                                                                                                                                                                                                                                                                  
        }
        if('<c:out value="${DisabledAnnuityReceiptForm.criInJnme4}" />'!=""){
    ...
    function saveTempEvtData(){
        ...
        $("tempPayEeacc").value = $("payEeacc").value; //帳號(後)  
    ...
    <div id="main" class="mainBody">
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">                                                                                                                                                                                                                                                        
                <html:form action="/disabledAnnuityReceiptModify" method="post" onsubmit="return validateDisabledAnnuityReceiptForm(this);">                                                                                                                                                                                                                          
                ...
                <html:hidden styleId="actionTyp" property="actionTyp" value="updateMode"/>
                                                                                                                                                                                                                                                                                                                                                                      
                <tr>                                                                                                                                                                                                                                                                                                                                          
                    <td colspan="2" align="right">                                                                                                                                                                                                                                                                                                            
                        <acl:checkButton buttonName="btnConfirm">                                                                                                                                                                                                                                                                                             
                            <input tabindex="700" type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doUpdate'; if (document.DisabledAnnuityReceiptForm.onsubmit() && checkFields() && isValidEvtDateTrue()){document.DisabledAnnuityReceiptForm.submit();}else{return false;}" />&nbsp;                                  
                        </acl:checkButton>                                                                                                                                                                                                                                                                                                                    
                        <acl:checkButton buttonName="btnDelete">                                                                                                                                                                                                                                                                                               
                            <input tabindex="710" type="button" name="btnDelete" class="button" value="刪　除" onclick="$('page').value='1'; $('method').value='doDelete'; if(confirm('<bean:message bundle="<%=Global.BA_MSG%>" key="msg.delete.confirm"/>')){document.DisabledAnnuityReceiptForm.submit();}else{return false;}"/>&nbsp;                                                                                                                                                                                                               
                        </acl:checkButton>                                                                                                                                                                                                                                                                                                                    
                        <acl:checkButton buttonName="btnBack">                                                                                                                                                                                                                                                                                                
                            <input tabindex="720" type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doModifyBack'; document.DisabledAnnuityReceiptForm.submit();"/>                                                                                                                                       
                        </acl:checkButton>                                                                                                                                                                                                                                                                                                                    
                    </td>                                                                                                                                                                                                                                                                                                                                     
                </tr>                                                                                                                                                                                                                                                                                                                                         
                <tr>                                                                                                                                                                                                                                                                                                                                          
                        ...
                        <table width="100%" border="0" class="px13">                                                                                                                                                                                                                                                                                          
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td>                                                                                                                                                                                                                                                                                                                          
                                    ...
                                    <c:out value="${DisabledAnnuityReceiptForm.apNoStrDisplay}"/>
                                </td>                                                                                                                                                                                                                                                                                                                         
                                <td>                                                                                                                                                                                                                                                                                                                          
                        ...
                        <table width="98%" cellpadding="3" cellspacing="4" class="px13">                                                                                                                                                                                                                                                                      
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss" colspan="2">                                                                                                                                                                                                                                                                                                     
                                    ...
                                    <html:text tabindex="30" property="evtNationTpe" styleId="evtNationTpe" styleClass="textinput" size="1" maxlength="1" onkeyup="changeEvtNationTpe();" onkeypress="chgEvtNationTpeFocus();" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                           
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                ...
                                <td id="iss" width="50%">　 <span class="issuetitle_L_down">國　籍：</span>                                                                                                                                                                                                                                                   
                                    <html:text tabindex="50" property="evtNationCode" styleId="evtNationCode" styleClass="textinput" size="3" maxlength="3" onblur="this.value=asc(this.value);"/>                                                                                                                                                            
                                    <label>                                                                                                                                                                                                                                                                                                                   
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss">                                                                                                                                                                                                                                                                                                                 
                                    ...
                                    <html:text tabindex="80" property="evtIdnNo" styleId="evtIdnNo" styleClass="textinput"  size="25" maxlength="20" onblur="this.value=asc(this.value).toUpperCase();initCvldtlName();autoForeignEvtSex();"/>                                                                                                                                    
                                </td>                                                                                                                                                                                                                                                                                                                         
                                <td id="iss">                                                                                                                                                                                                                                                                                                                 
                                    <span class="needtxt">＊</span>                                                                                                                                                                                                                                                                                           
                                    <span class="issuetitle_L_down">事故者出生日期：</span>                                                                                                                                                                                                                                                                   
                                    <html:text tabindex="90" property="evtBrDate" styleId="evtBrDate" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value);initCvldtlName();"/>                                                                                                                                                   
                                </td>                                                                                                                                                                                                                                                                                                                         
                            </tr>                                                                                                                                                                                                                                                                                                                             
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss">　 <span class="issuetitle_L_down">電　話1：</span>                                                                                                                                                                                                                                                              
                                    <html:text tabindex="100" property="tel1" styleId="tel1" styleClass="textinput" size="20" maxlength="20" onblur="this.value=asc(this.value).toUpperCase(); enableMobilePhone();"/>                                                                                                                                                             
                                </td>                                                                                                                                                                                                                                                                                                                         
                                <td id="iss">　 <span class="issuetitle_L_down">電　話2：</span>                                                                                                                                                                                                                                                              
                                    <html:text tabindex="110" property="tel2" styleId="tel2" styleClass="textinput" size="20" maxlength="20" onblur="this.value=asc(this.value).toUpperCase(); enableMobilePhone();"/>                                                                                                                                                             
                                </td>                                                                                                                                                                                                                                                                                                                         
                            </tr>                                                                                                                                                                                                                                                                                                                             
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td colspan="2" id="iss">                                                                                                                                                                                                                                                                                                     
                                    ...
                                    <html:text tabindex="120" property="commTyp" styleId="commTyp" styleClass="textinput" size="1" maxlength="1" onkeyup="changeCommTyp();" onkeypress="chgCommTypFocus();" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                                              
                                    <span class="formtxt">(1-同戶籍地，2-現住址)
                                              現住址：<html:text tabindex="130" property="commZip" styleId="commZip" styleClass="textinput" size="6" maxlength="6" onblur="this.value=asc(this.value);"/>                                                                                                   
                                    (郵遞區號)&nbsp;-<html:text tabindex="140" property="commAddr" styleId="commAddr" styleClass="textinput" size="72" maxlength="240" onblur="this.value=asc(this.value);"/></span>                                                                                                                                          
                                </td>                                                                                                                                                                                                                                                                                                                         
                            </tr>
                            <tr>
                                <td id="iss" colspan="2">
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss">　 <span class="issuetitle_L_down">法定代理人身分證號：</span>                                                                                                                                                                                                                                                   
                                    <html:text tabindex="160" property="grdIdnNo" styleId="grdIdnNo" styleClass="textinput" size="25" maxlength="20" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                                                                                                     
                                </td>                                                                                                                                                                                                                                                                                                                         
                            ...
                            <tr style="display: none;">                                                                                                                                                                                                                                                                                                                              
                                ...
                                <td id="iss">　 <span class="issuetitle_L_down">受傷部位：</span>                                                                                                                                                                                                                                                             
                                    <html:text tabindex="210" property="criInPart1" styleId="criInPart1" styleClass="textinput" size="3" maxlength="3" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                             
                                    <html:text tabindex="220" property="criInPart2" styleId="criInPart2" styleClass="textinput" size="3" maxlength="3" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                             
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td colspan="2" id="iss">　 <span class="issuetitle_L_down">失能項目：</span>                                                                                                                                                                                                                                                 
                                    <html:text tabindex="250" property="criInJdp1" styleId="criInJdp1" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="260" property="criInJdp2" styleId="criInJdp2" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="270" property="criInJdp3" styleId="criInJdp3" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="280" property="criInJdp4" styleId="criInJdp4" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="290" property="criInJdp5" styleId="criInJdp5" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="300" property="criInJdp6" styleId="criInJdp6" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="310" property="criInJdp7" styleId="criInJdp7" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="320" property="criInJdp8" styleId="criInJdp8" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="330" property="criInJdp9" styleId="criInJdp9" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                               
                                    <html:text tabindex="340" property="criInJdp10" styleId="criInJdp10" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                                                                                                   
                                </td>                                                                                                                                                                                                                                                                                                                         
                            </tr>                                                                                                                                                                                                                                                                                                                             
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss">　 <span class="issuetitle_L_down">醫療院所代碼：</span>                                                                                                                                                                                                                                                         
                                    <html:text tabindex="350" property="hosId" styleId="hosId" styleClass="textinput" size="10" maxlength="10" onblur="this.value=asc(this.value).toUpperCase(); if(Trim(this.value)!=''){this.value=leftPad(this.value, 10, '0');}"/>                                                                                                                                                           
                                </td>                                                                                                                                                                                                                                                                                                                         
                                <td id="iss">　 <span class="issuetitle_L_down">醫師姓名：</span>                                                                                                                                                                                                                                                             
                                    <html:text tabindex="360" property="doctorName1" styleId="doctorName1" styleClass="textinput" size="12" maxlength="12" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                                                                           
                                    <html:text tabindex="370" property="doctorName2" styleId="doctorName2" styleClass="textinput" size="12" maxlength="12" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                                                                                                                                                 
                                </td>                                                                                                                                                                                                                                                                                                                         
                            </tr>                                                                                                                                                                                                                                                                                                                             
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss" colspan="2">　 <span class="issuetitle_L_down">國際疾病代碼：</span>                                                                                                                                                                                                                                             
                                    <html:text tabindex="380" property="criInJnme1" styleId="criInJnme1" styleClass="textinput" size="30" maxlength="30" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                             
                                    <html:text tabindex="390" property="criInJnme2" styleId="criInJnme2" styleClass="textinput" size="30" maxlength="30" onblur="this.value=asc(this.value).toUpperCase();"/>&nbsp;                                                                                                                                             
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss" colspan="2">                                                                                                                                                                                                                                                                                                     
                                    ...
                                    <html:text tabindex="420" property="payTyp" styleId="payTyp" styleClass="textinput" size="1" maxlength="1" onkeyup="changePayTyp();" onblur="this.value=asc(this.value).toUpperCase();tabChange();"/>                                                                                                                                 
            ...
            <html:form action="/disabledAnnuityReceiptModifyFam" method="post" onsubmit="return validateDisabledAnnuityReceiptFamForm(this);">                                                                                                                                                                                                                          
                <html:hidden styleId="famPage" property="page" value="1" />                                                                                                                                                                                                                                                                                              
                <html:hidden styleId="famMethod" property="method" value="" />
                <html:hidden styleId="famActionTyp" property="actionTyp" value="updateMode"/>
                <html:hidden styleId="famOptionMode" property="famOptionMode" value=""/>
                <html:hidden styleId="famBafamilyId" property="bafamilyId"/>
                <html:hidden styleId="famBaappbaseId" property="baappbaseId" value="${DisabledAnnuityReceiptForm.baappbaseId}"/>
                <html:hidden styleId="famApNo" property="apNo" value="${DisabledAnnuityReceiptForm.apNo}"/>
                <html:hidden styleId="famSeqNo" property="seqNo"/>
                        ...
                        <table width="98%" cellpadding="3" cellspacing="4" class="px13">                                                                                                                                                                                                                                                                      
                            ...
                            <tr>                                                                                                                                                                                                                                                                                                                              
                                <td id="iss" colspan="2">　 <span class="issuetitle_L_down">是否在學：</span>                                                                                                                                                                                                                                                 
                                    <html:text tabindex="620" property="studMk" styleId="studMk" styleClass="textinput" size="1" maxlength="1" onkeyup="chgStud();" onblur="this.value=asc(this.value).toUpperCase();"/>                                                                                                                                                           
                ...
                <tr align="center">                                                                                                                                                                                                                                                                                                                           
                    <td class="issuetitle_L">                                                                                                                                                                                                                                                                                                                 
                        ...
                        <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>" >                                                                                                                                                                                                                                       
                            ...
                            <display:column property="famIdnNo" title="身分證號" style="width:12%; text-align:left;" />
                            <display:column title="在　學" style="width:10%; text-align:center;" >                                                                                                                                                                                                                                                                
                                <c:if test='${listItem.studMkStr ne ""}'>                                                                                                                                                                                                                                                                                       
                                    <c:out value="${listItem.studMkStr}" />
                                </c:if>                                                                                                                                                                                                                                                                                                                           
                                <c:if test='${listItem.studMkStr eq ""}'>                                                                                                                                                                                                                                                                                        
                                    &nbsp;
                                </c:if>                                                                                                                                                                                                                                                                                                                             
                            </display:column>                                                                                                                                                                                                                                                                                                                     
                            ...
                            <display:column title="操作區" style="width:14%; text-align:center;" >                                                                                                                                                                                                                                                                
                                <acl:checkButton buttonName="btnUpdate">                                                                                                                                                                                                                                                                                       
                                    <input type="button" class="button" name="btnUpdate" value="修　改" onclick="getFamDetailData('<c:out value="${listItem.bafamilyId}" />');$('dataIdx').value=<c:out value="${listItem_rowNum}" />;$('dataIndex').innerHTML=<c:out value="${listItem_rowNum}" />;$('famOptionMode').value='updateMode';">&nbsp;
                                </acl:checkButton>                                                                                                                                                                                                                                                                                                                
                                <acl:checkButton buttonName="btnDeleteFam">                                                                                                                                                                                                                                                                                       
                                    <input type="button" class="button" name="btnDeleteFam" value="刪　除" onclick="$('famPage').value='1'; $('famMethod').value='doDeleteFamData'; $('bafamilyId').value='<c:out value="${listItem.bafamilyId}" />'; $('baappbaseId').value='<c:out value="${listItem.baappbaseId}" />'; $('apNo').value='<c:out value="${listItem.apNo}" />'; if(confirm('<bean:message bundle="<%=Global.BA_MSG%>" key="msg.delete.confirm"/>')){document.DisabledAnnuityReceiptFamForm.submit();}else{return false;}">
                                </acl:checkButton>                                                                                                                                                                                                                                                                                                                
                            </display:column>                                                                                                                                                                                                                                                                                                                     
                        </display:table>                                                                                                                                                                                                                                                                                                                      
                    </td>                                                                                                                                                                                                                                                                                                                                     
