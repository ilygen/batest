...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3K0L" />
    ...
    <html:javascript formName="MonthlyRpt20Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt20Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt20" method="post" onsubmit="if($('method').value==''){return false;}else{return validateMonthlyRpt20Form(this);}">
        
        <fieldset>
            <legend>&nbsp;應收款立帳核定清單&nbsp;</legend>
                ...
                <tr>
                    <td colspan="3" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt20Form.onsubmit()){document.MonthlyRpt20Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
