...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D360L" />
    ...
    <html:javascript formName="MonthlyRpt06Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt06Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt06" method="post" onsubmit="return validateMonthlyRpt06Form(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt06Form.onsubmit()){document.MonthlyRpt06Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
