...
<html:html lang="true">
<head>
    <acl:setProgId progId="BARC0D013Q03" />
    ...
    <div id="main" class="mainBody">
        ...
        <fieldset>
            ...
            <table width="98%" border="0" align="center" cellpadding="2" cellspacing="2" class="px13">
                ...
                <tr>
                    <td colspan="7" align="center" class="table1">
                        <table width="98%" cellpadding="3" cellspacing="5" class="px13">
                            ...
                            <tr align="center">
                                <td>
                                    <bean:define id="seniList" name="<%=ConstantKey.PAYMENT_DECISION_SENIMAINT_DATA_LIST%>" />
                ...
                <tr align="center">
                    <td>
                        <bean:define id="ciptList" name="<%=ConstantKey.PAYMENT_DECISION_CIPT_DATA_LIST%>" />
