...
<html>
	<head>
		<acl:setProgId progId="BAMO0D288C" />
        ...
        function changePayCategory(){
            if($("payCategory").value=="1"){
                $("accSeqNo").value='<c:out value="${SurvivorPayeeDataUpdateDetailCase.seqNo}" />';
                $("payBankIdBranchId").value ='<c:out value="${SurvivorPayeeDataUpdateDetailCase.payBankId}"/>' + '<c:out value="${SurvivorPayeeDataUpdateDetailCase.branchId}" />';
                $("payEeacc").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payEeacc}" />';
                $("payAccount").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payBankId}" />' + '<c:out value="${SurvivorPayeeDataUpdateDetailCase.branchId}" />' + '<c:out value="${DisabledPayeeDataUpdateDetailCase.payEeacc}" />';
            ...
            if($("payCategory").value=="2"){
                ...
                var accseq = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.accSeqNo}" />';
                var accrel = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.accRel}" />';
        ...
        function initPayType() {
            ...
            $("payBankIdBranchId").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payBankId}"/>' + '<c:out value="${SurvivorPayeeDataUpdateDetailCase.branchId}" />';
            $("payEeacc").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payEeacc}" />';
            $("bankName").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.bankName}" />';
            if (payTyp == "1" || payTyp == "2") {
                $("accountContent1").style.display = "inline";
                $("accountContent2").style.display = "none";
                $("accountContent3").style.display = "inline";
            ...
            if (payTyp == "5" || payTyp == "6") {
                $("accName").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.accName}" />';
                $("payBankId").value="";  
                $("branchId").value=""; 
                $("payAccount").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payBankId}" />' + '<c:out value="${SurvivorPayeeDataUpdateDetailCase.branchId}" />' + '<c:out value="${SurvivorPayeeDataUpdateDetailCase.payEeacc}" />';
                $("bankName").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.bankName}" />';
                $("accountContent1").style.display = "none";
                $("accountContent2").style.display = "inline";
                $("accountContent3").style.display = "inline";
        ...
        function changeCommTyp(){
            if($("commTyp").value=="1"){
                $("commZip").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.commZip}" />';
                $("commAddr").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.commAddr}" />';
        ...
        function initBenNationType(){
        	...
        	if($("benNationTyp").value=="2"){
        		$("benSex").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.benSex}" />';
        		$("benNationCode").value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.benNationCode}" />';
        ...
        var DefaultMarritalStatusSetter = {
            ...
            initMarritalStatus : function() {
                var mk = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.benMarrMk}"/>';
		...
		if(document.getElementsByName("benNationTyp")[1].checked && document.getElementsByName("benSex")[0].checked==true){
            ...
            if(!validator.isRequiredValueEmpty('「關係」', $('benEvtRel'))){
                ...
                if(Trim($F("payTyp")) === '1' || Trim($F("payTyp")) === '2') {
                    ...
                    validator.checkLength('當「給付方式」為1或2時,「遺屬身份證號」', $F('benIdnNo'), 10);
       ...
       function autoTabChange(){
        ...
        function initAll(){
            ...
            checkIdnoExist();
            var frm = document.forms['SurvivorPayeeDataUpdateDetailForm'];
            $('benNationTyp').value = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.benNationTyp}"/>';
            $('commTyp').value ='<c:out value="${SurvivorPayeeDataUpdateDetailCase.commTyp}" />';
            var accRel = '<c:out value="${SurvivorPayeeDataUpdateDetailCase.accRel}" />';
            if(accRel != '1'){
                $("payCategory").value = "2";
							...
							<tr>
								<td align="right">
                                    ...
                                    <acl:checkButton buttonName="btnSave">
										<input name="btnSave" type="button" class="button" value="確　認" onclick="checkIdnoExist();$('page').value='1'; $('method').value='doConfirmInherit'; if (document.SurvivorPayeeDataUpdateDetailForm.onsubmit() && checkRequireFields()){
