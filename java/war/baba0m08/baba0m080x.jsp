...
<%@ page import="tw.gov.bli.ba.bj.forms.MonthCheckLForm" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN">
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M080X" />
    ...
    <html:javascript formName="MonthCheckLForm" page="1" />      
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/monthCheckL" method="post" onsubmit="return validateMonthCheckLForm(this);">
        <html:hidden styleId="page" property="page" value="1" />
        <html:hidden styleId="method" property="method" value="" />
        
        <fieldset>
            <legend>&nbsp;老年年金線上月試核作業&nbsp;</legend>
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" tabindex="500" name="btnQuery" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doQuery'; if(document.MonthCheckLForm.onsubmit()&&checkFields()){document.MonthCheckLForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnQueryList">
                            <input type="button" tabindex="510" name="btnQueryList" class="button" value="查  詢" onclick="$('page').value='1'; $('method').value='doQueryList'; if (document.MonthCheckLForm.onsubmit()){document.MonthCheckLForm.submit();}else{return false;}" />
                        </acl:checkButton>
                        &nbsp;
