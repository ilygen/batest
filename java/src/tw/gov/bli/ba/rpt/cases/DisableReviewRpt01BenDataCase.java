...
/**
 * Case for 勞保失能年金給付受理編審清單 - 受款人資料
 * 
 * @author Evelyn Hsu
 */

public class DisableReviewRpt01BenDataCase implements Serializable{
 ...
 // 給付主檔 - 受款人資料
    ...
    // 受款人給付資料
    // [
    private List<DisableReviewRpt01BenPayDataCase> benPayList;
    ...
    public DisableReviewRpt01BenDataCase() {
    ...
    public List<DisableReviewRpt01BenPayDataCase> getBenPayList() {
        return benPayList;
    }
    public void setBenPayList(List<DisableReviewRpt01BenPayDataCase> benPayList) {
