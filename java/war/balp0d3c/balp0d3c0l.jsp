...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3C0L" />
    ...
    <html:javascript formName="MonthlyRpt12Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt12Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt12" method="post" onsubmit="return validateMonthlyRpt12Form(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt12Form.onsubmit()){document.MonthlyRpt12Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
