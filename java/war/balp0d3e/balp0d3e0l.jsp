...
<html:html lang="true">
<head>
    <acl:setProgId progId="BALP0D3E0L" />
    ...
    <html:javascript formName="MonthlyRpt14Form" page="1" />
    ...
    <%-- begin ... [ --%>
    function resetForm(){
        document.MonthlyRpt14Form.reset();
        initAll();       
    }
    <%-- ] ... end --%>
...
<body scroll="no">
    ...
    <div id="main" class="mainBody">
        <html:form action="/printMonthlyRpt14" method="post" onsubmit="return validateMonthlyRpt14Form(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnPrint">
                            <input name="btnPrint" type="button" class="button" value="列　印" onclick="$('page').value='1'; $('method').value='doReport'; if (document.MonthlyRpt14Form.onsubmit()){document.MonthlyRpt14Form.submit();}else{return false;}"/>&nbsp;
                        </acl:checkButton>
