...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M143Q" />
                ...
                <tr>
                    <td colspan="8" align="right">
                        <acl:checkButton buttonName="btnBack">
                          <input type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doBack';  document.OldMediaBatchForm.submit();" />&nbsp;
                         </acl:checkButton>                                             
                    </td>
                </tr>                
