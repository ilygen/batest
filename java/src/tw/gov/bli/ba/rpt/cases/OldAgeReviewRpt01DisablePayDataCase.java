...
/**
 * Case for 勞保老年年金給付受理編審清單 - 請領他類給付資料 - 申請失能給付記錄
 * 
 * @author Goston
 */
public class OldAgeReviewRpt01DisablePayDataCase implements Serializable {
    ...
    private String bmCriInjDp; // 失能項目
    private String bmCriInjCl; // 失能等級
    ...
    public OldAgeReviewRpt01DisablePayDataCase() {
