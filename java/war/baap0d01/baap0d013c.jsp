...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAAP0D013C" />
    ...
    // Ajax for 取得 戶籍檔姓名  20121220 邏輯修改 拿掉if條件 && (isValidDate($("evtBrDate").value))
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/oldAgeAnnuityReceiptModify" method="post" onsubmit="return validateOldAgeAnnuityReceiptForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        <acl:checkButton buttonName="btnConfirm">
                            <input tabindex="260" type="button" name="btnConfirm" class="button" value="確　認" onclick="$('page').value='1'; $('method').value='doUpdate'; if (document.OldAgeAnnuityReceiptForm.onsubmit() && checkFields() && isValidEvtDateTrue()){document.OldAgeAnnuityReceiptForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnDelete">
                            <input tabindex="270" type="button" name="btnDelete" class="button" value="刪　除"  onclick="$('page').value='1'; $('method').value='doDelete'; if(confirm('再次確認是否刪除!?')){document.OldAgeAnnuityReceiptForm.submit();}else{return false;}" />&nbsp;
                        </acl:checkButton>
                        <acl:checkButton buttonName="btnBack">
                            <input tabindex="280" type="button" name="btnBack" class="button" value="返　回" onclick="$('page').value='1'; $('method').value='doModifyBack'; document.OldAgeAnnuityReceiptForm.submit()" />
                        </acl:checkButton>                        
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="100%" border="0" cellpadding="2" cellspacing="2" class="px13">
                            <tr>
                                <td>
                                    ...
                                    <html:text property="apNoStrDisplay" styleId="apNoStrDisplay" styleClass="textinput" disabled="true"/>                                   
                                </td>
                                <td>
                        ...
                        <table width="98%" cellpadding="3" cellspacing="4" class="px13">
                            ...
                            <tr>
                                <td colspan="2" id="iss">
                                    ...
                                    <span class="formtxt">
                                        (&nbsp;戶籍姓名<html:text property="cvldtlName" styleId="cvldtlName" styleClass="textinput" readonly="true" size="50"/>)
                                    </span>
                                </td>
                            </tr>
                            <tr>
                                <td id="iss"><span class="needtxt">＊</span><span class="issuetitle_L_down">事故者身分證字號：</span>
                                    <html:text tabindex="90" property="evtIdnNo" styleId="evtIdnNo" styleClass="textinput"  size="25" maxlength="20" onblur="this.value=asc(this.value).toUpperCase();initCvldtlName();autoForeignEvtSex();"/></td>
                                <td id="iss"><span class="needtxt">＊</span><span class="issuetitle_L_down">事故者出生日期：</span>
                                    <html:text tabindex="100" property="evtBrDate" styleId="evtBrDate" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value);initCvldtlName();"/></td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                <td id="iss"><span class="needtxt">＊</span><span class="issuetitle_R_down">申請項目：</span>
                                    <html:text tabindex="160" property="apItem" styleId="apItem" styleClass="textinput" size="1" maxlength="1" onblur="this.value=asc(this.value).toUpperCase();"/>
                            ...
                            <tr>
                                ...
                                <td class="issuetitle_L_down" id="iss">　法定代理人出生日期：
                                    <html:text tabindex="250" property="grdBrDate" styleId="grdBrDate" styleClass="textinput" size="8" maxlength="8" onblur="this.value=asc(this.value).toUpperCase();"/>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">&nbsp;</td>
