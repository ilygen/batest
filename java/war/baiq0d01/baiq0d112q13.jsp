...
<html:html lang="true">
<head>
    <acl:setProgId progId="BAIQ0D112Q13" />
                        ...
                        <tr>
                            <td align="center" class="table1">
                                ...
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="8" class="issuetitle_L"><span class="systemMsg">▲</span>&nbsp;失能資料</td>
                                    </tr>
                                    <tr>
                         ...
                         <tr>
                            <td align="center" class="table1">
                                <table width="98%" cellpadding="3" cellspacing="3" class="px13">
                                    <tr>
                                        <td colspan="8" class="issuetitle_L"><span class="systemMsg">▲</span>&nbsp;重新查核失能程度資料</td>
                                    </tr>
                                    <tr>
                                        <td colspan="8" align="center">
                                            ...
                                            <display:table name="pageScope.list" id="listItem" pagesize="<%=ConstantKey.LIST_PAGE_SIZE%>"> 
                                                ...
                                                <display:column title="重新查核失能程度年月" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:center;">
                                                    <c:out value="${listItem.reChkYm}" />&nbsp;
                                                </display:column>                   
                                                <display:column title="是否複檢" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:center;">
                                                    <c:out value="${listItem.isreChkStr}" />&nbsp;
                                                </display:column>
                                                <display:column title="重新查核狀態" headerClass="issuetitle_L" class="issueinfo_C" style="width:15%; text-align:left;">
                                                    <c:out value="${listItem.reChkStatusStr}" />&nbsp;
                                                </display:column>
                                                <display:column title="重新查核結果" headerClass="issuetitle_L" class="issueinfo_C" style="width:20%; text-align:left;">
                                                    <c:out value="${listItem.reChkResultStr}" />&nbsp;
                                                </display:column>
                                                <display:column title="完成重新查核年月" headerClass="issuetitle_L" class="issueinfo_C" style="width:20%; text-align:center;">
