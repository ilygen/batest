...
<html:html lang="true">
<head>
    <acl:setProgId progId="BABA0M050X" />
...
<div id="mainContent">
    ...
    <div id="main" class="mainBody">
        <html:form action="/monthBatchL" method="post" onsubmit="return validateMonthBatchLForm(this);">
                ...
                <tr>
                    <td colspan="2" align="right">
                        ...
                        <acl:checkButton buttonName="btnConfirm">
                            <input type="button" name="btnConfirm" class="button" value="確  認" onclick="$('page').value='1'; $('method').value='doConfirm'; if (document.MonthBatchLForm.onsubmit()){document.MonthBatchLForm.submit();}else{return false;}" tabindex="6"/>
                        </acl:checkButton>
                        &nbsp;
                        <acl:checkButton buttonName="btnQuery">
                            <input type="button" name="btnQuery" class="button_90" value="進度查詢" onclick="$('page').value='1'; $('method').value='doQuery'; document.MonthBatchLForm.submit();" tabindex="7"/>
                        </acl:checkButton>
                        &nbsp;
